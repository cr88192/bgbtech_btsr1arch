...
dt_bool PIT_AddLineIntercepts (line_t *ld)
{
	int                     s1, s2;
	fixed_t         frac;
	divline_t       dl;
...
dt_bool PIT_AddThingIntercepts (mobj_t  *thing)
{
	fixed_t         x1,y1, x2,y2;
	int                     s1, s2;
	dt_bool         tracepositive;
	divline_t       dl;
	fixed_t         frac;
...
dt_bool P_TraverseIntercepts ( traverser_t func, fixed_t maxfrac )
{
	int                             count;
	fixed_t                 dist;
	intercept_t             *scan, *in;
