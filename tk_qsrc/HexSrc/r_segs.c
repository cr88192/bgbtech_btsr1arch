...
dt_bool         segtextured;    // true if any of the segs textures might be vis
dt_bool         markfloor;              // false if the back side is the same plane
dt_bool         markceiling;
dt_bool         maskedtexture;
...
//			angle = (rw_centerangle + xtoviewangle[rw_x])>>ANGLETOFINESHIFT;
			angle = (rw_centerangle +
				xtoviewangle[rw_x&PADSCREENWIDTHMASK])>>ANGLETOFINESHIFT;
