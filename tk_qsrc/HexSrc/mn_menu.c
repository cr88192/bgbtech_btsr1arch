...
extern dt_bool gamekeydown[256]; // The NUMKEYS macro is local to g_game
...
dt_bool MN_Responder(event_t *event)
{
	int key;
	int i;
	MenuItem_t *item;
	extern dt_bool automapactive;
	static dt_bool shiftdown;
