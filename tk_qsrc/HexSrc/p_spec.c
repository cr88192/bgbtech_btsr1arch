...
static dt_bool CheckedLockedDoor(mobj_t *mo, byte lock);
...
dt_bool EV_SectorSoundChange(byte *args)
{
	int secNum;
	dt_bool rtn;
...
dt_bool EV_LineSearchForPuzzleItem(line_t *line, byte *args, mobj_t *mo)
{
	player_t *player;
	int i;
...
dt_bool P_ActivateLine(line_t *line, mobj_t *mo, int side, int activationType)
{
	int lineActivation;
	dt_bool repeat;
	dt_bool buttonSuccess;
