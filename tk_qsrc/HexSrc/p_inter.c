...
/*
dt_bool P_GiveWeapon(player_t *player, pclass_t class, weapontype_t weapon)
{
	dt_bool gaveMana;
	dt_bool gaveWeapon;
...
/*
dt_bool P_GiveWeaponPiece(player_t *player, pclass_t class, int piece)
{
...
dt_bool P_MorphMonster(mobj_t *actor)
{
