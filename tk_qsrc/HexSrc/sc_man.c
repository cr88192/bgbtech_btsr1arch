...
static dt_bool ScriptOpen = false;
static dt_bool ScriptFreeCLib; // true = de-allocate using free()
static int ScriptSize;
static dt_bool AlreadyGot = false;
