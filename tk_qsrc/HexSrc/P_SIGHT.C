...
dt_bool         PTR_SightTraverse (intercept_t *in)
{
	line_t  *li;
	fixed_t slope;
...
dt_bool P_SightBlockLinesIterator (int x, int y )
{
	int                     offset;
	short           *list;
	line_t          *ld;
...
dt_bool P_SightTraverseIntercepts ( void )
{
	int                             count;
	fixed_t                 dist;
	intercept_t             *scan, *in;
...
dt_bool P_SightPathTraverse (fixed_t x1, fixed_t y1, fixed_t x2, fixed_t y2)
{
