...
int V_CheckPointerRam(byte *base, int sz) 
{
	if(base<((byte *)0x8C000000))
		return(0);
	if((base+sz)>=((byte *)0x98000000))
		return(0);
	return(1);
}
...
//	return;
	...
	destmin=screens[scrn];
	destmax=destmin+SCREENWIDTH*SCREENHEIGHT;
