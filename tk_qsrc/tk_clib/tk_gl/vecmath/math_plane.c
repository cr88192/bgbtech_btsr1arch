...
void PlaneF_NearestPointLinePlane(float *start, float *end,
	float *norm, float *pt)
{
	float d0, d1;
	int i;
...
void PlaneF_BoxAxisExtents(float *mins, float *maxs,
...
void PlaneF_BoxPlaneExtents(float *mins, float *maxs,
	float *norm, float *min, float *max)
{
