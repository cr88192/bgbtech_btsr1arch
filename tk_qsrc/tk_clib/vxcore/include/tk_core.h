...
#ifdef __riscv
// static const u64 MMIO_BASE_E = 0xFFFFF000E000ULL;
extern u64 MMIO_BASE_E;
#else
#define MMIO_BASE_E	0xFFFFF000E000ULL
#endif
...
#define GPIO_BASE		(MMIO_BASE_E+0x0000100ULL)
#define SPI_BASE		(MMIO_BASE_E+0x0000030ULL)
#define UART_BASE		(MMIO_BASE_E+0x0000010ULL)
#define AIC_BASE		(MMIO_BASE_E+0x0000200ULL)
#define PS2_BASE		(MMIO_BASE_E+0x0000040ULL)
