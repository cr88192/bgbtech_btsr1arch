...
u32 __subsf3(u32 f0, u32 f1)
{
	u32 f2;
	f2=__addsf3(f0, f1^0x80000000U);
	return(f2);
}

u32 __mulsf3(u32 f0, u32 f1)
{
	u32 f2, sg;
	int e0, e1, e2;
	int m0, m1, m2;
...
u64 __subdf3(u64 f0, u64 f1)
{
	u64 f2;
	f2=__adddf3(f0, f1^0x8000000000000000ULL);
	return(f2);
}

u64 __muldf3(u64 f0, u64 f1)
{
	u64 f2, sg;
	u64 m0, m1, m2;
	u64 m3, m4, m5, m6;
...
u64 __trunctfdf2(u32 a)
{
}

u64 __extendsfdf2(u32 f0)
{
	u64 f1, sg;
...
u64 __extenddftf2(u64 a)
{
}

s32 __fixdfsi(u64 f0)
{
	s32 t;
	u32 f2;
	int e0, e1, e2;
...
//	u32 m0, m1, m2;
	...
	e0=(f0>>52)&2047;
	m0=0x0080000000000000ULL|((f0&0x000FFFFFFFFFFFFFULL)<<3);
...
u32 __floatdisf(s64 a)
{
	...
	fva=__floatsisf(a>>31);
	fvb=__floatsisf(a&0x7FFFFFFF);
	fva+=31<<23;
	if(a<0)
		fvb^=0x80000000;
	fv=__addsf3(fva, fvb);
...
u64 __floatdidf(s64 a)
{
	...
	fva=__floatsidf(a>>31);
	fvb=__floatsidf(a&0x7FFFFFFF);
	fva+=31ULL<<52;
	if(a<0)
		fvb^=0x8000000000000000ULL;
	fv=__adddf3(fva, fvb);
	return(fv);
}

u64 __floatundidf(u64 a)
{
	return(__floatdidf(a));
}

int __eqdf2(u64 a, u64 b)
{
	if(((a>>52)&0x7FF)==0x7FF)
	{
		if(a<<12)
...
int __nedf2(u64 a, u64 b)
{
	return(!__eqdf2(a, b));
}

int __gtdf2(u64 a, u64 b)
{
	if(a>>63)
	{
		if(b>>63)
...
int __ltdf2(u64 a, u64 b)
{
	return(__gtdf2(b, a));
}

int __gedf2(u64 a, u64 b)
{
	return(!__ltdf2(a, b));
}

int __ledf2(u64 a, u64 b)
{
	return(!__gtdf2(a, b));
}
...
int __nesf2(u32 a, u32 b)
{
	return(!__eqsf2(a, b));
}

int __gtsf2(u32 a, u32 b)
{
	if(a>>31)
	{
		if(b>>31)
...
int __ltsf2(u32 a, u32 b)
{
	return(__gtsf2(b, a));
}

int __gesf2(u32 a, u32 b)
{
	return(!__ltsf2(a, b));
}

int __lesf2(u32 a, u32 b)
{
	return(!__gtsf2(a, b));
}


u64 __muldc3(u64 ar, u64 ai, u64 br, u64 bi)
{
}

u64 __divdc3(u64 ar, u64 ai, u64 br, u64 bi)
{
}
