...
#define _O_SHM		0x00040000	//BGB: Shared Memory

#define	_O_RANDOM	0x00100000
#define	_O_SEQUENTIAL	0x00200000
#define	_O_TEMPORARY	0x00400000
#define	_O_NOINHERIT	0x00800000
#define _O_SHORT_LIVED  0x10000000
