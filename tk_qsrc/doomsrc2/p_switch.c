...
{				 
	...
	if(gamemode==heretic)
	{
		switch(spop)
		{
		case 100: spop=105; break;		//fast raise stairs (W)
//		case 104: spop=0; break;		//light goes to minumum
		case 105: spop=124; break;		//exit secret
		case 106: spop=100; break;		//fast raise stairs (W)
		case 107: spop=127; break;		//fast raise stairs (S)
		default: break;
		}
	}
