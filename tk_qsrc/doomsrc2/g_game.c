...
//	memset (mousebuttons, 0, sizeof(mousebuttons));
	memset (mousebuttons, 0, 3*sizeof(boolean));
//	memset (joybuttons, 0, sizeof(joybuttons));
	memset (joybuttons, 0, 4*sizeof(boolean));
}
...
//	buf = NetDivTicdup(gametic);
//	buf = buf-((buf/BACKUPTICS)*BACKUPTICS);
...
void G_ReadDemoTiccmd (ticcmd_t* cmd)
{
	...
	cmd->angleturn = (((int)((unsigned char)(*demo_p++)))<<8);
