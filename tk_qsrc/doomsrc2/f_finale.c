...
//    src = W_CacheLumpName ( finaleflat , PU_CACHE);
    src = W_CacheFlatName ( finaleflat , PU_CACHE);
    dest = screens[0];
...
//    patch = W_CacheLumpNum (lump+firstspritelump, PU_CACHE);
    patch = W_CachePatchNum (lump+firstspritelump, PU_CACHE);
    if (flip)
...
//		     (SCREENHEIGHT-8*8)/2,0, W_CacheLumpName ("END0",PU_CACHE));
		     (SCREENHEIGHT-8*8)/2,0, W_CachePatchName ("END0",PU_CACHE));
	laststage = 0;
	return;
    }
...
//			 W_CacheLumpName("CREDIT",PU_CACHE));
			 W_CachePatchName("CREDIT",PU_CACHE));
	    else
	      V_DrawPatch (0,0,0,
//			 W_CacheLumpName("HELP2",PU_CACHE));
			 W_CachePatchName("HELP2",PU_CACHE));
	    break;
	  case 2:
	    V_DrawPatch(0,0,0,
//			W_CacheLumpName("VICTORY2",PU_CACHE));
			W_CachePatchName("VICTORY2",PU_CACHE));
	    break;
	  case 3:
	    F_BunnyScroll ();
	    break;
...
//			 W_CacheLumpName("ENDPIC",PU_CACHE));
			 W_CachePatchName("ENDPIC",PU_CACHE));
	    break;
	}
    }
