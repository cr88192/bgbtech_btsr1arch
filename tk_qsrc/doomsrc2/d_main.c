...
void D_Display (void)
{
	...
	wipegamestate = gamestate;		//BGB: wipe doesn't seem to work with 16bpp
...
//		d_main_curtime = I_GetTime();
		...
		dt = d_main_curtime - d_main_lasttime;
		d_main_lasttime = d_main_curtime;
...
//	V_DrawPatch (0,0, 0, W_CacheLumpName(pagename, PU_CACHE));
	V_DrawPatchDirectName (0,0, 0, pagename);
}
