...
VECMATH_API void SolidAABB_BoxMove(float *bmins, float *bmaxs,
...
VECMATH_API void SolidAABB_BoxIntersection(float *ma, float *na,
...
VECMATH_API int SolidOBB_CheckObbPlane(float *mins, float *maxs,
...
VECMATH_API int SolidOBB_ObbPlaneIntersect(float *mins, float *maxs,
	float *xform, float *norm, float *io)
{
	float pts[8*3];
	float bo[3];
...
VECMATH_API int SolidOBB_ObbPlaneExtents(float *mins, float *maxs,
...
VECMATH_API void SolidOBB_PlaneExtents(float *mins, float *maxs,
...
VECMATH_API int SolidOBB_ObbPlaneMoveExtents(float *mins, float *maxs,
...
VECMATH_API int SolidOBB_CheckObbMovePlane(float *mins, float *maxs,
...
VECMATH_API int SolidOBB_CheckCollide(
...
VECMATH_API int SolidOBB_CheckObbMove(
...
VECMATH_API int SolidOBB_ObbImpactNormal(
	float *amins, float *amaxs, float *aspos, float *aepos,
	float *bmins, float *bmaxs, float *bspos, float *bepos,
...
VECMATH_API void SolidOBB_Box(float *mins, float *maxs, float *pos,
...
VECMATH_API void SolidOBB_BoxMove(
...
VECMATH_API int SolidOBB_ObbPointCollide(
...
VECMATH_API int SolidOBB_BoxLineCollideP(float *min, float *max, float *pos,
	float *sp, float *ep)
{
	float vsp[4], vep[4];
	int i;
