...
//		sprintf(t, "A%d;", asz);
	...
	if(bt<256)
	{
		...
		case CCXL_TY_FIMAG:			*t++='C'; *t++='f'; break;
		case CCXL_TY_DIMAG:			*t++='C'; *t++='d'; break;
		case CCXL_TY_GIMAG:			*t++='C'; *t++='g'; break;
		case CCXL_TY_HIMAG:			*t++='C'; *t++='k'; break;
...
ccxl_status BGBCC_CCXL_GetTypeBinaryDest(
	...
	ccxl_type *rdty)
{
	int i0, i1, i2, sgz, ltyb, rtyb, dtyb;
