...
const short bgbcc_bsr_lcachereg[8]={
...
int BGBCC_BSRC_ConvLpRegisterNarrowing(
	BGBCC_TransState *ctx,
	BGBCC_BSR_Context *sctx,
	int nmid,
	ccxl_register sreg,
...
//		nm1=BGBCC_SH_NMID_MOV;
		BGBCC_BSR_EmitOpRegReg(sctx, nm1, BGBCC_SH_REG_R4, cdreg);
...
//		nm1=BGBCC_SH_NMID_MOV;
		BGBCC_BSR_EmitOpRegReg(sctx, nm1, csreg, BGBCC_SH_REG_R4);
	...
	}else
	{
		...
		if(nm1!=BGBCC_SH_NMID_MOV)
			BGBCC_BSR_EmitOpReg(sctx, nm1, BGBCC_SH_REG_R4);
...
int BGBCC_BSRC_ConvLpRegisterWiden(
	BGBCC_TransState *ctx,
	BGBCC_BSR_Context *sctx,
	ccxl_type stype,
	ccxl_register sreg,
	ccxl_register dreg)
{
		...
		(cdreg>=0) && (cdreg!=BGBCC_SH_REG_ZZR))
	{
		...
		}else
		{
			BGBCC_BSR_EmitOpRegReg(sctx, BGBCC_SH_NMID_MOV,
				csreg, (cdreg&15)+1);
			BGBCC_BSRC_EmitLeaSarRegImm(ctx, sctx,
				(cdreg&15)+1, 31);
		}
