...
int BGBCC_JX2X3_CheckEncodeRIRJ_Imm10sB(
	BGBCC_JX2_Context *ctx,
	s64 opwb, int rm, s64 imm, int rn,
	s64 *ropw1, s64 *ropw2, s64 *ropw3)
{
...
//	return(0);
	...
	return(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10I(ctx,
		opwb, rm, imm, rn, ropw1, ropw2, ropw3));
}
...
int BGBCC_JX2X3_CheckEncodeRIRJ_Imm10s(
	...
	s64 *ropw1, s64 *ropw2)
{
	return(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10sB(ctx,
		opwb, rm, imm, rn, ropw1, ropw2, NULL));
}

int BGBCC_JX2X3_CheckEncodeRIRJ_Imm10uB(
	BGBCC_JX2_Context *ctx,
	s64 opwb, int rm, s64 imm, int rn,
	s64 *ropw1, s64 *ropw2, s64 *ropw3)
{
...
int BGBCC_JX2X3_CheckEncodeRIRJ_Imm10u(
	...
	s64 *ropw1, s64 *ropw2)
{
	return(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10uB(ctx,
		opwb, rm, imm, rn, ropw1, ropw2, NULL));
}

int BGBCC_JX2X3_CheckEncodeRIRJ_Imm9u(
	BGBCC_JX2_Context *ctx,
	s64 opwb, int rm, s64 imm, int rn,
	s64 *ropw1, s64 *ropw2)
{
...
//	return(0);
	...
	if((imm>=0) && (imm<=511))
	{
		*ropw1=opwb|((rm&63)<<16)|((rn&63)<<6)|((imm&511)<<22);
		return(1);
	}
...
int BGBCC_JX2X3_CheckEncodeRIRJ_Imm9uB(
	BGBCC_JX2_Context *ctx,
	s64 opwb, int rm, s64 imm, int rn,
	s64 *ropw1, s64 *ropw2, s64 *ropw3)
{
...
//	return(0);
	...
	{
		return(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10I(ctx,
			opwb, rm, immsc, rn, ropw1, ropw2, NULL));
	}
...
//	if(((s32)(imm))==imm)
//	if((((s32)imm)==imm) || (((u32)imm)==imm))
	if(((imm|(~0xFFFFFFFFLL))==imm) || (((u32)imm)==imm))
		isimm33s=1;
...
int BGBCC_JX2X3_CheckEncodeLd2RDRJ(
	BGBCC_JX2_Context *ctx,
	s64 opwb, int sdu, int rm, int ro, int disp, int rn,
	int sc, int fixsc,
	s64 *ropw1, s64 *ropw2)
{
	s64 opw1, opw2;
...
int BGBCC_JX2X3_CheckEncodeRIRJ_Imm17sI(
	BGBCC_JX2_Context *ctx,
	s64 opwb, int rm, s64 imm, int rn,
	s64 *ropw1, s64 *ropw2)
{
...
int BGBCC_JX2X3_CheckEncodeRIRJ_Imm16fp(
	BGBCC_JX2_Context *ctx,
	s64 opwb, int rm, s64 imm, int rn,
	s64 *ropw1, s64 *ropw2)
{
...
//		return(0);
	...
	if(((u16)imm)==imm)
	{
		...
		return(BGBCC_JX2X3_CheckEncodeRIRJ_Imm17sI(
			ctx, opwb, rm, imm, rn, ropw1, ropw2));
	}
#endif
	...
	if(((imm>>32)<<32)==imm)
	{
		return(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(
			ctx, opwb, rm, (u32)(imm>>32), rn, ropw1, ropw2));
	}
#endif

#if 1
	rt=BGBCC_JX2_ConstConvDoublePack32(imm, &imm_dp32);
	if(rt>0)
	{
		return(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(
			ctx, opwb, rm, 0xFFFFFFFF00000000LL|imm_dp32, rn, ropw1, ropw2));
	}
#endif

#if 0
	rt=BGBCC_JX2_ConstConvDoubleToHalf(imm, &imm_f16);
	if(rt>0)
	{
		return(BGBCC_JX2X3_CheckEncodeRIRJ_Imm17sI(
			ctx, opwb, rm, imm_f16, rn, ropw1, ropw2));
	}
#endif
...
int BGBCC_JX2X3_CheckEncodeIRJ_Imm6I(
	BGBCC_JX2_Context *ctx,
	s64 opwb, s64 imm, int reg,
	s64 *ropw1, s64 *ropw2)
{
	s64 opw1, opw2;
	int isimm29s, isimm33s;
...
int BGBCC_JX2X3_CheckEncodeRIDJ_Imm17sDisp10sI(
	BGBCC_JX2_Context *ctx,
	s64 opwb, int rm, s64 imm, int disp, int shr,
	s64 *ropw1, s64 *ropw2)
{
	s64 opw1, opw2;
	int disp10;
	int isimm17s, isdisp10s;
...
//	return(0);
	...
	if((((s32)(imm<<15))>>15)==imm)
		isimm17s=1;
	if((((s32)(disp10<<22))>>22)==disp10)
		isdisp10s=1;
	
	if(isimm17s && isdisp10s)
	{
		*ropw1=0x0800801EU |
			(((imm>> 4)&0x07FF)<<16) ;
		*ropw2=opwb|
...
//	return(0);
	...
	case BGBCC_SH_NMID_SUBX:
		if(!(ctx->has_alux&1))
			break;
		opw1=0x10001022U|((ro&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
		break;
	...
	case BGBCC_SH_NMID_ORX:
		if(!(ctx->has_alux&1) && !(ctx->has_pushx2&1))
			break;
		opw1=0x60001022U|((ro&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
		break;
	...
	case BGBCC_SH_NMID_XORX:
		if(!(ctx->has_alux&1))
			break;
		opw1=0x70001022U|((ro&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
		break;
#endif
...
//		opw1=0x20008022U|((ro&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
		opw1=0x90009022U|((ro&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
		break;
	case BGBCC_SH_NMID_NTST:
//		opw1=0x20008022U|((ro&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
//		opw1=0x10008022U|((ro&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
		opw1=0x80009022U|((ro&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
		break;
...
#if 1
	case BGBCC_SH_NMID_CMPQLTU:
//	case BGBCC_SH_NMID_CMPLT:
		opw1=0xA0009022U|((rm&63)<<22)|((ro&63)<<16)|((rn&63)<<6);
		break;
	case BGBCC_SH_NMID_CMPQLEU:
//	case BGBCC_SH_NMID_CMPLT:
//		opw1=0xB0009022U|((rm&63)<<22)|((ro&63)<<16)|((rn&63)<<6);
		opw1=0xB0009022U|((ro&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
		break;
#endif

	case BGBCC_SH_NMID_CMPQHI:
	case BGBCC_SH_NMID_CMPHI:
		opw1=0xA0009022U|((ro&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
		break;
...
//		opw1=0xF0009022U|((rm&63)<<22)|((ro&63)<<16)|((rn&63)<<6);
	...
	case BGBCC_SH_NMID_CMPXEQ:
		if(!(ctx->has_alux&1))
			break;
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0x60003022U, 0x4000,
			rm, ro, rn, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_CMPXNE:
		if(!(ctx->has_alux&1))
			break;
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0x60003022U, 0x5000,
			rm, ro, rn, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_CMPXGT:
		if(!(ctx->has_alux&1))
			break;
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0x60003022U, 0x6000,
			rm, ro, rn, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_CMPXGE:
		if(!(ctx->has_alux&1))
			break;
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0x60003022U, 0x7000,
			ro, rm, rn, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_CMPXLT:
		if(!(ctx->has_alux&1))
			break;
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0x60003022U, 0x6000,
			ro, rm, rn, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_CMPXLE:
		if(!(ctx->has_alux&1))
			break;
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0x60003022U, 0x7000,
			rm, ro, rn, &opw1, &opw2);
	...
	case BGBCC_SH_NMID_TSTX:
		if(!(ctx->has_alux&1))
			break;
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0x60003022U, 0x8000,
			rm, ro, rn, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_NTSTX:
		if(!(ctx->has_alux&1))
			break;
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0x60003022U, 0x9000,
			rm, ro, rn, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_CMPXGTU:
		if(!(ctx->has_alux&1))
			break;
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0x60003022U, 0xA000,
			rm, ro, rn, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_CMPXGEU:
		if(!(ctx->has_alux&1))
			break;
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0x60003022U, 0xB000,
			ro, rm, rn, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_CMPXLTU:
		if(!(ctx->has_alux&1))
			break;
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0x60003022U, 0xA000,
			ro, rm, rn, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_CMPXLEU:
		if(!(ctx->has_alux&1))
			break;
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0x60003022U, 0xB000,
			rm, ro, rn, &opw1, &opw2);
	...
	case BGBCC_SH_NMID_RGB5CCENC2:
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0x80006022U, 0xA000,
			rm, ro, rn, &opw1, &opw2);
		break;


	case BGBCC_SH_NMID_BLKUVF1VL:
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0xC0007002U, 0x0040,
			rm, ro, rn, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_BLKUVF1VH:
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0xC0007002U, 0x0041,
			rm, ro, rn, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_BLKUVF1SL:
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0xC0007002U, 0x0042,
			rm, ro, rn, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_BLKUVF1SH:
		BGBCC_JX2X3_CheckEncodeRRRJ(ctx, 0xC0007002U, 0x0043,
			rm, ro, rn, &opw1, &opw2);
		break;
	}
	...
	BGBCC_JX2_Context *ctx, int nmid, int rm, int rn)
{
	...
	{
		if((nm1<0) && ((ctx->has_alux&1) || (ctx->has_pushx2&1)))
			nm1=BGBCC_SH_NMID_ORX;

//		if(ctx->has_alux&1)
//		if((nm1<0) && (ctx->has_alux&1))
//			nm1=BGBCC_SH_NMID_ADDX;
			
//		if(ctx->has_simdx2&1)
//		if((nm1<0) && (ctx->has_simdx2&1))
//		{
...
//		nm1=BGBCC_SH_NMID_FSUB;
	...
	case BGBCC_SH_NMID_NOT:
		opw1=0xC0001002U|((rm&63)<<16)|((rn&63)<<6);
		break;
	case BGBCC_SH_NMID_NOTX:
		opw1=0xC0001022U|((rm&63)<<16)|((rn&63)<<6);
		break;
#endif
	...
	case BGBCC_SH_NMID_FNEGX:
		rm1=rm+1;		rn1=rn+1;
		opw1=0xD2001002U|((rm1&63)<<16)|((rn1&63)<<6);
		break;
	case BGBCC_SH_NMID_FABSX:
		rm1=rm+1;		rn1=rn+1;
		opw1=0xD2401002U|((rm1&63)<<16)|((rn1&63)<<6);
		break;
...
//		break;
	...
	case BGBCC_SH_NMID_CONVFXI:
		opw1=0x83C01002U|((rm&63)<<16)|((rn&63)<<6);
		break;
	case BGBCC_SH_NMID_CONVFLI:
		opw1=0x83C01022U|((rm&63)<<16)|((rn&63)<<6);
		break;
	
	case BGBCC_SH_NMID_PCVTHTOF8:
		opw1=0xA0001002U|((rm&63)<<16)|((rn&63)<<6);
		break;
	case BGBCC_SH_NMID_PCVTF8TOH:
		opw1=0xA0401002U|((rm&63)<<16)|((rn&63)<<6);
		break;

	case BGBCC_SH_NMID_PCVTH2AL:
		opw1=0xF3001002U|((rm&63)<<16)|((rn&63)<<6);
		break;
	case BGBCC_SH_NMID_PCVTAL2H:
		opw1=0xF3401002U|((rm&63)<<16)|((rn&63)<<6);
		break;

	case BGBCC_SH_NMID_MOVZT:
		opw1=0x82801002U|((rm&63)<<16)|((rn&63)<<6);
		break;
	case BGBCC_SH_NMID_XMOVZT:
		opw1=0x82801022U|((rm&63)<<16)|((rn&63)<<6);
		break;

	case BGBCC_SH_NMID_CLZ:
		opw1=0xC0801002U|((rm&63)<<16)|((rn&63)<<6);
		break;
	case BGBCC_SH_NMID_CLZQ:
		opw1=0xC0801022U|((rm&63)<<16)|((rn&63)<<6);
		break;

	case BGBCC_SH_NMID_PCVTSW2H:
		opw1=0xF1401002U|((rm&63)<<16)|((rn&63)<<6);
		break;
	case BGBCC_SH_NMID_PCVTUW2H:
		opw1=0xF1401022U|((rm&63)<<16)|((rn&63)<<6);
		break;

	case BGBCC_SH_NMID_PCVTH2SW:
		opw1=0xF1C01002U|((rm&63)<<16)|((rn&63)<<6);
		break;
	case BGBCC_SH_NMID_PCVTH2UW:
		opw1=0xF1C01022U|((rm&63)<<16)|((rn&63)<<6);
		break;

	case BGBCC_SH_NMID_RGB5PCKI8:
		opw1=0xF3001022U|((rm&63)<<16)|((rn&63)<<6);
		break;
	case BGBCC_SH_NMID_RGB5UPCKI8:
		opw1=0xF3401022U|((rm&63)<<16)|((rn&63)<<6);
		break;

	case BGBCC_SH_NMID_RGB5MINMAX:
		opw1=0xE0001022U|((rm&63)<<16)|((rn&63)<<6);
		break;

	case BGBCC_SH_NMID_BNDCHKB:
		opw1=0x80001002U|((rm&63)<<16)|((rn&63)<<6);
		break;
	case BGBCC_SH_NMID_BNDCHKW:
		opw1=0x80401002U|((rm&63)<<16)|((rn&63)<<6);
		break;
	case BGBCC_SH_NMID_BNDCHKL:
		opw1=0x80801002U|((rm&63)<<16)|((rn&63)<<6);
		break;
	case BGBCC_SH_NMID_BNDCHKQ:
		opw1=0x80C01002U|((rm&63)<<16)|((rn&63)<<6);
		break;

	case BGBCC_SH_NMID_MOV:
		crm=BGBCC_JX2_TryMapRegCn(ctx, rm);
		crn=BGBCC_JX2_TryMapRegCn(ctx, rn);
//		opw1=0xC0001002U|((rm&63)<<16)|((rn&63)<<6);

		if(BGBCC_JX2_EmitCheckRegExtGPR(ctx, rm) && (crn>0))
			{ opw1=0x92801002U|((rm&63)<<16)|((crn&63)<<6); }
		if(BGBCC_JX2_EmitCheckRegExtGPR(ctx, rn) && (crm>0))
			{ opw1=0x92C01002U|((crm&63)<<16)|((rn&63)<<6); }
	...
	s64 *ropw1, s64 *ropw2, s64 *ropw3)
{
	...
	u32 imm_4xf8, imm_4xub, imm_f64dp;
	u16 imm_f16, imm1_f16, imm2_f16, imm3_f16, imm4_f16;
	...
	rt5=BGBCC_JX2_ConstConvV4HToV4FP8(imm, &imm_4xf8);
	rt6=BGBCC_JX2_ConstConvRGBA64To32(imm, &imm_4xub);
	rt7=BGBCC_JX2_ConstConvDoublePack32(imm, &imm_f64dp);
...
#if 0
	if((opw1<0) && (((imm&0x01FF)==imm) || ((imm|(~0x01FF))==imm)))
	{
		opw1=0x0000000AU|((rn&63)<<6)|((imm&0x3FF)<<22);
		if(!ctx->is_simpass)
			{	ctx->stat_const_imm10s++;	}
	}
#endif
	...
	if(	(opw1<0) && 
		((imm&0xFFFF)==((imm>>16)&0xFFFF)) &&
		((imm&0xFFFF)==((imm>>32)&0xFFFF)) &&
		((imm&0xFFFF)==((imm>>48)&0xFFFF)) )
	{
		opw1=0x00004032U|((rn&63)<<6)|((imm&0xFFFF)<<16);

		if(!ctx->is_simpass)
		{
			ctx->stat_const_imm16++;
			ctx->stat_const_imm16sw++;
		}
	}
		...
		!ctx->op_is_wex2)
	{
		...
		imm1=immhi&0xFFFFF;
		if((immhi<<12)==imm)
//		if((imm&0x7FFFF000)==imm)
		{
			opw1=0x00000037U|((rn&31)<<7)|(imm1<<12);
...
//				ctx->stat_const_imm16++;
...
#if 0
	immhi=(imm>>32);
	if((opw1<0) && ((immhi<<32)==imm) && (ctx->has_fpim&1))
	{
		BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx, 0x88002022U,
			BGBCC_SH_REG_RQ0, (u32)immhi, rn, &opw1, &opw2);
	...
	if((opw1<0) && ((immhi<<32)==imm) && (ctx->has_fpim&1))
	{
		BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx, 0xD0006022U,
			BGBCC_SH_REG_RQ0,
			(u32)immhi, rn, &opw1, &opw2);
...
#if 1
	if((opw1<0) && (rt1>0) && (ctx->has_fpim&1))
	{
		BGBCC_JX2X3_CheckEncodeIRJ_Imm6I(ctx, 0xD0001002U,
			imm_f32, rn, &opw1, &opw2);
...
#if 1
	if((opw1<0) && (rt3>0) && (ctx->has_fpim&1))
	{
		BGBCC_JX2X3_CheckEncodeIRJ_Imm6I(ctx, 0xE3001002U,
			imm_2xf16, rn, &opw1, &opw2);
...
#if 1
	if((opw1<0) && (rt5>0) && (ctx->has_fpim&1))
	{
		BGBCC_JX2X3_CheckEncodeIRJ_Imm6I(ctx, 0xA0401002U,
			imm_4xf8, rn, &opw1, &opw2);
...
#if 1
	if((opw1<0) && (rt6>0) && (ctx->has_fpim&1))
	{
		BGBCC_JX2X3_CheckEncodeIRJ_Imm6I(ctx, 0xE1401022U,
			imm_4xub, rn, &opw1, &opw2);

		if(!ctx->is_simpass && (opw1>=0))
		{
			ctx->stat_const_jumbo64++;
			ctx->stat_const_jumbo64_4xub++;
		}
	}
#endif

#if 0
	if((opw1<0) && (rt7>0) && (ctx->has_fpim&1))
	{
		BGBCC_JX2X3_CheckEncodeIRJ_Imm6I(ctx, 0xE1C01022U,
			imm_f64dp, rn, &opw1, &opw2);

		if(!ctx->is_simpass && (opw1>=0))
		{
			ctx->stat_const_jumbo64++;
			ctx->stat_const_jumbo64_f64dp++;
		}
	}
#endif
	...
	if((opw1<0) && (rt7>0) && (ctx->has_fpim&1))
	{
		BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx, 0xD0006022U,
			BGBCC_SH_REG_RQ0,
			imm_f64dp|(~0xFFFFFFFFULL), rn, &opw1, &opw2);
	...
	if((opw1<0) && (ctx->has_jumbo&4) && !ctx->op_is_wex2)
	{
#if 0
		opw1=0x0000001AU|
			(((imm>>40)&0xFFFF)<<16)|
...
#if 1
		BGBCC_JX2X3_CheckEncodeRIRJ_Imm10I(ctx, 0x0000000AU,
			0, imm, rn, &opw1, &opw2, &opw3);
#endif
		...
		if(!ctx->is_simpass && (opw1>=0))
		{
			...
			if((k<16) && (k>-16))
			{
				printf("Imm Miss: %016llX %.16f\n", imm, *(double *)(&imm));
			}else
			{
				printf("Imm Miss: %016llX\n", imm);
			}
#endif
	...
	BGBCC_JX2_Context *ctx, int nmid, s64 imm, int rn)
{
	...
	if(	(nmid==BGBCC_SH_NMID_CMPQEQ) ||
		...
		(nmid==BGBCC_SH_NMID_CMPQNE) ||
		(nmid==BGBCC_SH_NMID_CMPQGE) ||
		(nmid==BGBCC_SH_NMID_CMPQHI) ||
		(nmid==BGBCC_SH_NMID_CMPQHS) )
	{
		if(!(ctx->has_jcmp&16))
			return(0);
...
#if 1
	if(	(nmid==BGBCC_SH_NMID_TST  ) ||
		(nmid==BGBCC_SH_NMID_TSTQ ) )
	{
		if(!(ctx->has_jcmp&16))
			return(0);
		return(BGBCC_JX2X3_TryEmitOpRegImmReg(
			ctx, BGBCC_SH_NMID_NTST, rn, imm, BGBCC_SH_REG_RQ0));
	}
	
	if(nmid==BGBCC_SH_NMID_NTST)
	{
		if(!(ctx->has_jcmp&16))
			return(0);
		return(BGBCC_JX2X3_TryEmitOpRegImmReg(
			ctx, BGBCC_SH_NMID_TSTQ, rn, imm, BGBCC_SH_REG_RQ0));
	}
#endif
		...
		(nmid==BGBCC_SH_NMID_MOVX2))
	{
		if(ctx->has_alux&1)
		{
			...
			{
				return(BGBCC_JX2X3_TryEmitOpRegImmReg(
					ctx, BGBCC_SH_NMID_ADDX, BGBCC_SH_REG_RQ0, imm, rn));
			}
		}

		if(!ctx->emit_isprobe)
		{
			BGBCC_JX2RV_EmitOpImmReg(
				ctx, BGBCC_SH_NMID_MOV, imm, rn+0);
			BGBCC_JX2RV_EmitOpImmReg(
				ctx, BGBCC_SH_NMID_MOV, imm>>63, rn+1);
			return(1);
		}
	}
...
//		return(0);
	...
	case BGBCC_SH_NMID_MOV:
		...
		if(!ctx->emit_isprobe)
		{
//			if(((imm>>16)==(s16)(imm>>16)) || ((imm>>16)==(u16)(imm>>16)))
			if(1)
			{
				BGBCC_JX2RV_EmitOpImmReg(
					ctx, BGBCC_SH_NMID_MOV, imm>>16, rn);
				BGBCC_JX2RV_EmitOpImmReg(
					ctx, BGBCC_SH_NMID_LDSH16, imm&0xFFFF, rn);
			}else
			{
				BGBCC_JX2RV_EmitOpImmReg(
					ctx, BGBCC_SH_NMID_MOV, imm>>32, rn);
				BGBCC_JX2RV_EmitOpImmReg(
					ctx, BGBCC_SH_NMID_LDSH32, imm&0xFFFFFFFFULL, rn);
			}
			return(1);
		}
...
//		break;
	...
	case BGBCC_SH_NMID_FLDCH:
		if(((u16)imm)==imm)
		{
			opw1=0x00004012U|((rn&63)<<6)|((imm&0xFFFF)<<16);
			break;
		}
		break;
	case BGBCC_SH_NMID_PLDCSW:
		if(((u16)imm)==imm)
		{
			opw1=0x00004032U|((rn&63)<<6)|((imm&0xFFFF)<<16);
			break;
	...
	BGBCC_JX2_Context *ctx, int nmid, int rm, s64 imm, int rn)
{
	...
	int isimm16s, isimm17s, isimm5u, isimm12s;
	int isimm12rv, isimm9u, isimm9n, isimm_fp16, rt;
...
//	isimm_fp16=(rt>0);
	...
	if((imm&511)==imm)		isimm9u=1;
	if((imm|(~511))==imm)	isimm9n=1;

	if((((s32)(imm<<24))>>24)==imm)
		isimm8s=1;

	if((imm&31)==imm)		isimm5u=1;
	...
	case BGBCC_SH_NMID_ADD:
		...
		if(isimm12rv)
		{
			opw1=0x00000013|((rn&31)<<7)|((rm&31)<<15)|((imm&4095)<<20);
			break;
		}
#endif

		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10uB(ctx, 0x0000000AU,
			rm, imm, rn, &opw1, &opw2, &opw3)>0)
				break;
		break;
...
//		}
//		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm9u(ctx, 0x0000200AU,
//		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10u(ctx, 0x0000200AU,
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10s(ctx, 0x0000200AU,
			rm, imm, rn, &opw1, &opw2)>0)
				break;
		break;
	case BGBCC_SH_NMID_DMULU:
//		opw1=0x0000202AU|((imm&1023)<<22)|((rm&63)<<16)|((rn&63)<<6);
//		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm9u(ctx, 0x0000202AU,
//		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10u(ctx, 0x0000202AU,
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10s(ctx, 0x0000202AU,
			rm, imm, rn, &opw1, &opw2)>0)
				break;
		break;
...
//		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm9u(ctx,
		...
		if(isimm6s)
		{
			opw1=0xC0009022U|((imm&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
			break;
		}

		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx,
			0xC0005002U, rm, imm, rn, &opw1, &opw2)>0)
				break;
#endif
...
//		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx,
//			0xC0005022, rm, imm, rn, &opw1, &opw2)>0)
//				break;
	...
	case BGBCC_SH_NMID_AND:
		...
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10sB(ctx,
			0x0000500AU, rm, imm, rn, &opw1, &opw2, &opw3)>0)
				break;
		break;
...
//	case BGBCC_SH_NMID_RSUBSL:
...
#endif
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10sB(ctx,
			0x0000502AU, rm, imm, rn, &opw1, &opw2, &opw3)>0)
				break;
		break;
	...
	case BGBCC_SH_NMID_RSUBSL:
		...
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10I(ctx,
			0xC000502AU, rm, imm, rn, &opw1, &opw2, NULL)>0)
				break;
		break;
		
	case BGBCC_SH_NMID_RSUBUL:
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10I(ctx,
			0x8000502AU, rm, imm, rn, &opw1, &opw2, NULL)>0)
				break;
		break;
	...
	case BGBCC_SH_NMID_MULSL:
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10s(ctx,
			0x0000200AU, rm, imm, rn, &opw1, &opw2)>0)
				break;
		break;
	case BGBCC_SH_NMID_MULUL:
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10s(ctx,
			0x0000202AU, rm, imm, rn, &opw1, &opw2)>0)
				break;
		break;
#endif
...
//		if(isimm8s || isimm8u)
		...
		{
			if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10I(ctx,
				0x4000802AU, rm, imm, rn, &opw1, &opw2, &opw3)>0)
					break;
		}
		break;

	case BGBCC_SH_NMID_PSHUFL:
...
//		if(isimm8s || isimm8u)
		if(isimm8u)
		{
			opw1=0x4000702AU|((imm&255)<<22)|((rm&63)<<16)|((rn&63)<<6);
			break;
		}
		if((imm>>16)==-1)
		{
			if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10I(ctx,
				0x4000702AU, rm, imm, rn, &opw1, &opw2, &opw3)>0)
					break;
		}
		break;
...
//		if(isimm6u)
		...
		if(isimm17s && (imm>=0))
		{
			if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm17sI(ctx,
				0x10003022U, rm, imm, rn, &opw1, &opw2)>0)
					break;
		}
...
//		opw1=0x20008022U|((ro&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx,
//			0x20008022U, rm, imm, rn, &opw1, &opw2)>0)
			0x90009022U, rm, imm, rn, &opw1, &opw2)>0)
				break;
		break;
	case BGBCC_SH_NMID_NTST:
//		opw1=0x10008022U|((ro&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx,
//			0x10008022U, rm, imm, rn, &opw1, &opw2)>0)
			0x80009022U, rm, imm, rn, &opw1, &opw2)>0)
				break;
		break;

	case BGBCC_SH_NMID_CMPHI:
	case BGBCC_SH_NMID_CMPQHI:
//	case BGBCC_SH_NMID_CMPQGTU:
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx,
			0xA0009022U, rm, imm, rn, &opw1, &opw2)>0)
				break;
		break;
	case BGBCC_SH_NMID_CMPHS:
	case BGBCC_SH_NMID_CMPQHS:
//		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx,
//			0xB0009022U, rm, imm, rn, &opw1, &opw2)>0)
//				break;
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx,
			0xA0009022U, rm, imm-1, rn, &opw1, &opw2)>0)
				break;
	...
	case BGBCC_SH_NMID_CMPQLTU:
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx,
			0xB0009022U, rm, imm+1, rn, &opw1, &opw2)>0)
				break;
		break;
	case BGBCC_SH_NMID_CMPQLEU:
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx,
			0xB0009022U, rm, imm+0, rn, &opw1, &opw2)>0)
				break;
		break;
	...
	case BGBCC_SH_NMID_DIVSL:
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx,
			0x40007002U, rm, imm, rn, &opw1, &opw2)>0)
				break;
		break;
	case BGBCC_SH_NMID_DIVUL:
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx,
			0x40007022U, rm, imm, rn, &opw1, &opw2)>0)
				break;
		break;
	case BGBCC_SH_NMID_MODSL:
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx,
			0x50007002U, rm, imm, rn, &opw1, &opw2)>0)
				break;
		break;
	case BGBCC_SH_NMID_MODUL:
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx,
			0x50007022U, rm, imm, rn, &opw1, &opw2)>0)
				break;
		break;
#endif
	...
	case BGBCC_SH_NMID_ADDX:
		if(!(ctx->has_alux&1))
			break;
		if(imm==0)
			{ opw1=0x00001022U|((rm&63)<<16)|((rn&63)<<6); break; }
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx,
			0x00001022U, rm, imm, rn, &opw1, &opw2)>0)
				break;
		break;
	case BGBCC_SH_NMID_SUBX:
		if(!(ctx->has_alux&1))
	...
	case BGBCC_SH_NMID_ANDX:
		if(!(ctx->has_alux&1))
			break;
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm6I(ctx,
			0x50001022U, rm, imm, rn, &opw1, &opw2)>0)
				break;
		break;
	case BGBCC_SH_NMID_ORX:
		if(!(ctx->has_alux&1))
	...
	case BGBCC_SH_NMID_FADD:
		if(ctx->has_fpim&1)
		{
			if((imm>0) && (imm<64))
			{
				opw1=0xD0006022U|((imm&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
				break;
			}
		}

		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm16fp(ctx,
			0x80005002U, rm, imm, rn, &opw1, &opw2)>0)
				break;
#if 1
		if((imm>>32) && ((imm>>32)!=-1) && (ctx->has_fpim&1))
		{
			if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10I(ctx,
//				0x0000102AU, rm, imm, rn, &opw1, &opw2, &opw3)>0)
				0x0000302AU, rm, imm, rn, &opw1, &opw2, &opw3)>0)
					break;
		}
#endif
		break;
	case BGBCC_SH_NMID_FSUB:
		if(ctx->has_fpim&1)
		{
			if((imm>0) && (imm<64))
			{
				opw1=0xE0006022U|((imm&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
				break;
			}
		}

		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm16fp(ctx,
			0x90005002U, rm, imm, rn, &opw1, &opw2)>0)
				break;
#if 1
		if((imm>>32) && ((imm>>32)!=-1) && (ctx->has_fpim&1))
		{
			if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10I(ctx,
//				0x0000102AU, rm, imm^0x8000000000000000LL,
				0x0000302AU, rm, imm^0x8000000000000000LL,
				rn, &opw1, &opw2, &opw3)>0)
					break;
		}
#endif
	...
	case BGBCC_SH_NMID_FMUL:
		if(ctx->has_fpim&1)
		{
			if((imm>0) && (imm<64))
			{
				opw1=0xF0006022U|((imm&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
				break;
			}
		}

		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm16fp(ctx,
			0xA0005002U, rm, imm, rn, &opw1, &opw2)>0)
				break;
#if 1
		if((imm>>32) && ((imm>>32)!=-1) && (ctx->has_fpim&1))
		{
			if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm10I(ctx,
//				0x0000402AU, rm, imm, rn, &opw1, &opw2, &opw3)>0)
				0x0000300AU, rm, imm, rn, &opw1, &opw2, &opw3)>0)
					break;
		}
#endif
		break;
	...
	case BGBCC_SH_NMID_FCMPEQ:
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm16fp(ctx,
			0xD0009002U, rm, imm, rn, &opw1, &opw2)>0)
				break;
		break;
	case BGBCC_SH_NMID_FCMPLT:
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm16fp(ctx,
			0xE0009002U, rm, imm, rn, &opw1, &opw2)>0)
				break;
		break;
	case BGBCC_SH_NMID_FCMPGE:
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Imm16fp(ctx,
			0xF0009002U, rm, imm, rn, &opw1, &opw2)>0)
				break;
		break;
	}
	...
	BGBCC_JX2_Context *ctx, int nmid, int rm, int ro, int rn)
{
	...
	if(ctx->has_ldop&1)
	{
		...
		if(nm1>0)
		{
			return(BGBCC_JX2X3_TryEmitOpLdReg2DispReg(
				ctx, nmid, rm, ro, 0, rn));
		}
	}
...
//		opw1=0xB0000022U|((ro&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
		opw1=0xF0000022U|((ro&63)<<22)|((rm&63)<<16)|((rn&63)<<6);
		break;
	...
	BGBCC_JX2_Context *ctx, int nmid, int rm, int ro, int rn)
{
	...
	if(ctx->has_ldop&1)
	{
		...
		if(nm1>0)
		{
			return(BGBCC_JX2X3_TryEmitOpRegStReg2Disp(
				ctx, nmid, rm, ro, rn, 0));
		}
	}
	...
	int nmid, int rm, s64 disp, int rn)
{
	...
	case BGBCC_SH_NMID_LEAB:
		if((disp10b<<0)==disp)
		{
			opw1=0x00000026U|((disp10b&1023)<<22)|((rm&63)<<16)|((rn&63)<<6);
			break;
		}
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Disp10s(ctx,
			0x00000026U, rm, disp, 0, rn, &opw1, &opw2)>0)
				break;
		break;
	case BGBCC_SH_NMID_LEAW:
		if((disp10w<<1)==disp)
		{
			opw1=0x00001026U|((disp10w&1023)<<22)|((rm&63)<<16)|((rn&63)<<6);
			break;
		}
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Disp10s(ctx,
			0x00001026U, rm, disp, 1, rn, &opw1, &opw2)>0)
				break;
		break;
	case BGBCC_SH_NMID_LEAL:
		if((disp10l<<2)==disp)
		{
			opw1=0x00002026U|((disp10l&1023)<<22)|((rm&63)<<16)|((rn&63)<<6);
			break;
		}
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Disp10s(ctx,
			0x00002026U, rm, disp, 2, rn, &opw1, &opw2)>0)
				break;
		break;
	case BGBCC_SH_NMID_LEAQ:
		if((disp10q<<3)==disp)
		{
			opw1=0x00003026U|((disp10q&1023)<<22)|((rm&63)<<16)|((rn&63)<<6);
			break;
		}
		if(BGBCC_JX2X3_CheckEncodeRIRJ_Disp10s(ctx,
			0x00003026U, rm, disp, 3, rn, &opw1, &opw2)>0)
				break;
		break;
...
int BGBCC_JX2X3_TryEmitOpLdReg2DispReg(
	BGBCC_JX2_Context *ctx, int nmid, int rm, int ro, int disp, int rn)
{
	...
	if((ro&63)==0)
	{
		...
		if(rt>0)
		{
			return(BGBCC_JX2X3_TryEmitOpLdRegDispReg(
				ctx, nmid, rm, disp, rn));
		}
	}
	...
	if(disp==0)
	{
		...
		if(rt>0)
		{
			return(BGBCC_JX2X3_TryEmitOpLdReg2Reg(
				ctx, nmid, rm, ro, rn));
		}
	}
	...
	{
	case BGBCC_SH_NMID_LEAB:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0x40000022U, 0x0, rm, ro, disp, rn, 0, 0, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_LEAW:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0x50000022U, 0x0, rm, ro, disp, rn, 1, 1, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_LEAL:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0x60000022U, 0x0, rm, ro, disp, rn, 2, 2, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_LEAQ:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0x70000022U, 0x0, rm, ro, disp, rn, 3, 3, &opw1, &opw2);
		break;

	case BGBCC_SH_NMID_MOVB:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xC0000002U, 0x0, rm, ro, disp, rn, 0, 0, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_MOVW:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xD0000002U, 0x0, rm, ro, disp, rn, 1, 1, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_MOVL:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xE0000002U, 0x0, rm, ro, disp, rn, 2, 2, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_MOVQ:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xF0000002U, 0x0, rm, ro, disp, rn, 3, 3, &opw1, &opw2);
		break;

	case BGBCC_SH_NMID_MOVUB:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xC0000022U, 0x0, rm, ro, disp, rn, 0, 0, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_MOVUW:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xD0000022U, 0x0, rm, ro, disp, rn, 1, 1, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_MOVUL:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xE0000022U, 0x0, rm, ro, disp, rn, 2, 2, &opw1, &opw2);
		break;

	case BGBCC_SH_NMID_MOVVL:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xE0000002U, 0x8, rm, ro, disp, rn, 2, 2, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_MOVVQ:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xF0000002U, 0x8, rm, ro, disp, rn, 3, 3, &opw1, &opw2);
		break;

	case BGBCC_SH_NMID_SWAPL:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xE0000002U, 0x1, rm, ro, disp, rn, 2, 2, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_SWAPQ:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xF0000002U, 0x1, rm, ro, disp, rn, 3, 3, &opw1, &opw2);
		break;

	case BGBCC_SH_NMID_SWAPVL:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xE0000002U, 0x9, rm, ro, disp, rn, 2, 2, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_SWAPVQ:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xF0000002U, 0x9, rm, ro, disp, rn, 3, 3, &opw1, &opw2);
		break;

	case BGBCC_SH_NMID_ADDSL:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xE0000002U, 0x2, rm, ro, disp, rn, 2, 2, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_ADDUL:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xE0000022U, 0x2, rm, ro, disp, rn, 2, 2, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_ADD:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xF0000022U, 0x2, rm, ro, disp, rn, 3, 3, &opw1, &opw2);
		break;

	case BGBCC_SH_NMID_SUBSL:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xE0000002U, 0x3, rm, ro, disp, rn, 2, 2, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_SUBUL:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xE0000022U, 0x3, rm, ro, disp, rn, 2, 2, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_SUB:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xF0000022U, 0x3, rm, ro, disp, rn, 3, 3, &opw1, &opw2);
		break;

	case BGBCC_SH_NMID_RSUBSL:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xE0000002U, 0x4, rm, ro, disp, rn, 2, 2, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_RSUBUL:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xE0000022U, 0x4, rm, ro, disp, rn, 2, 2, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_RSUB:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xF0000022U, 0x4, rm, ro, disp, rn, 3, 3, &opw1, &opw2);
		break;

	case BGBCC_SH_NMID_ANDL:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xE0000002U, 0x5, rm, ro, disp, rn, 2, 2, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_AND:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xF0000022U, 0x5, rm, ro, disp, rn, 3, 3, &opw1, &opw2);
		break;

	case BGBCC_SH_NMID_ORL:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xE0000002U, 0x6, rm, ro, disp, rn, 2, 2, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_OR:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xF0000022U, 0x6, rm, ro, disp, rn, 3, 3, &opw1, &opw2);
		break;

	case BGBCC_SH_NMID_XORL:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xE0000002U, 0x7, rm, ro, disp, rn, 2, 2, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_XOR:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0xF0000022U, 0x7, rm, ro, disp, rn, 3, 3, &opw1, &opw2);
		break;
	}
...
int BGBCC_JX2X3_TryEmitOpRegStReg2Disp(
	BGBCC_JX2_Context *ctx, int nmid, int rm, int ro, int rn, int disp)
{
	...
	if((ro&63)==0)
	{
		...
		if(rt>0)
		{
			return(BGBCC_JX2X3_TryEmitOpRegStRegDisp(
				ctx, nmid, rm, rn, disp));
		}
	}
	...
	if(disp==0)
	{
		...
		if(rt>0)
		{
			return(BGBCC_JX2X3_TryEmitOpRegStReg2(
				ctx, nmid, rm, ro, rn));
		}
	}
	...
	case BGBCC_SH_NMID_MOVB_ST:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0x40000002U, 0x0, rn, ro, disp, rm, 0, 0, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_MOVW:
	case BGBCC_SH_NMID_MOVUW:
	case BGBCC_SH_NMID_MOVW_ST:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0x50000002U, 0x0, rn, ro, disp, rm, 1, 1, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_MOVL:
	case BGBCC_SH_NMID_MOVUL:
	case BGBCC_SH_NMID_MOVL_ST:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0x60000002U, 0x0, rn, ro, disp, rm, 2, 2, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_MOVQ:
	case BGBCC_SH_NMID_MOVQ_ST:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0x70000002U, 0x0, rn, ro, disp, rm, 3, 3, &opw1, &opw2);
		break;

	case BGBCC_SH_NMID_MOVVL:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0x60000002U, 0x8, rn, ro, disp, rm, 2, 2, &opw1, &opw2);
		break;
	case BGBCC_SH_NMID_MOVVQ:
		BGBCC_JX2X3_CheckEncodeLd2RDRJ(ctx,
			0x70000002U, 0x8, rn, ro, disp, rm, 3, 3, &opw1, &opw2);
		break;
	}
...
{
	s64 opw1, opw2, opw3, opw4;
	int odr, ex, ex2, nowxi, exw, rlty, rlty2, rlty3, rt, isrvr, isn6r;
	int i, j, k;
...
//	rm=BGBCC_JX2RV_NormalizeReg(ctx, rm);
	...
	if(	(imm<31) && (imm>(-32)) &&
		(BGBCC_JX2_EmitCheckAutoLabelNear6_X3(ctx, lbl, nmid)>0) )
			isn6r=1;
...
//			opw1=0x0000F006U|((rm&63)<<16)|((rn&63)<<6);
#if 1
			BGBCC_JX2X3_CheckEncodeRIDJ_Imm17sDisp10sI(
				ctx, 0x0000F006U, rn, imm, 4, 2,
				&opw1, &opw2);
			rlty2=BGBCC_SH_RLC_RELW10_XG3;
#endif
			break;
		}
		break;
...
//		rlty=BGBCC_SH_RLC_RELW33_XG3;
//		opw1=0x0000001AU;
//		opw2=0x0000602AU;
		break;
#if 0
	case BGBCC_SH_NMID_BSR8B:
		rlty=BGBCC_SH_RLC_RELW33_XG3;
		opw1=0x0000001AU;
		opw2=0x0000606AU;
		break;
...
int BGBCC_JX2X3_TryEmitOpNone(BGBCC_JX2_Context *ctx, int nmid)
{
	...
	if(nmid==BGBCC_SH_NMID_CLRT)
		return(BGBCC_JX2X3_TryEmitOpRegRegReg(ctx, BGBCC_SH_NMID_CMPQNE,
			BGBCC_SH_REG_ZZR, BGBCC_SH_REG_ZZR, BGBCC_SH_REG_ZZR));

	if(nmid==BGBCC_SH_NMID_SETT)
		return(BGBCC_JX2X3_TryEmitOpRegRegReg(ctx, BGBCC_SH_NMID_CMPQEQ,
			BGBCC_SH_REG_ZZR, BGBCC_SH_REG_ZZR, BGBCC_SH_REG_ZZR));

	if(nmid==BGBCC_SH_NMID_BRK)
	{
		return(BGBCC_JX2X3_TryEmitOpImmReg(ctx,
			BGBCC_SH_NMID_FLDCH, 0, BGBCC_SH_REG_RQ2));
	}
...
//			BGBCC_SH_REG_RQ0, BGBCC_SH_REG_RQ0, BGBCC_SH_REG_RQ0));
	...
	switch(nmid)
	{
	case BGBCC_SH_NMID_LDTLB:
		opw1=0x000033C2;
		break;
	case BGBCC_SH_NMID_LDACL:
		opw1=0x00803102;
		break;
	case BGBCC_SH_NMID_INVTLB:
		opw1=0x008033C2;
		break;
	}
...
int BGBCC_JX2X3_TryEmitOpReg(BGBCC_JX2_Context *ctx, int nmid, int reg)
{
	s64 opw1, opw2, opw3, opw4;
	int odr, ex, ex2, nowxi, exw, rlty, rlty2, rlty3, isrvr;
	int i, j, k;
...
//	return(0);
	...
	case BGBCC_SH_NMID_MOVT:
		opw1=0x00000008U|(1<<22)|((reg&63)<<6);
		opw2=0x00000009U|(0<<22)|((reg&63)<<6);
		break;
	case BGBCC_SH_NMID_MOVNT:
		opw1=0x00000008U|(0<<22)|((reg&63)<<6);
		opw2=0x00000009U|(1<<22)|((reg&63)<<6);
		break;

	case BGBCC_SH_NMID_INVIC:
		opw1=0x004C3002U|(1<<22)|((reg&63)<<6);
		break;
	case BGBCC_SH_NMID_INVDC:
		opw1=0x004D3002U|(1<<22)|((reg&63)<<6);
		break;
	}
