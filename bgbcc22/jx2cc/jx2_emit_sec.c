...
void BGBCC_JX2_UpdatePszxWord(BGBCC_JX2_Context *ctx, int val)
{
	...
	case 3:
		...
		case 2:
			...
			case 6:			case 7:
				rn=rn_dfl;	sx=BGBCC_PSZX_SSX;	break;
			default:
	...
	case 0xE:
		rn=(val>>8)&15;
		sx=(val&128)?BGBCC_PSZX_SX:BGBCC_PSZX_ZX;
		break;
	case 0xF:
		break;
	}
	...
	int opw1, int opw2)
{
	...
	case 0x5:
		switch((opw2>>8)&15)
		{
		case 0x4:	rn=rn_dfl; sx=BGBCC_PSZX_SX; break;
		case 0x5:	rn=rn_dfl; sx=BGBCC_PSZX_ZX; break;
