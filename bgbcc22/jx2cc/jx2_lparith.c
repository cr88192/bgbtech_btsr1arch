...
int BGBCC_JX2C_EmitBinaryLong_ShlImm(
	...
	int cdreg, int shl)
{
	...
	if(shl>=64)
	{
		BGBCC_JX2_EmitOpImmReg(sctx, BGBCC_SH_NMID_MOV, 0, cdreg2+0);
		BGBCC_JX2_EmitOpImmReg(sctx, BGBCC_SH_NMID_MOV, 0, cdreg2+1);
		return(1);
	}
...
//		if(nm1>=0)
		if(0)
		{
			BGBCC_JX2_EmitOpReg(sctx, nm1, cdreg2+1);
			if(nm2>=0)
				BGBCC_JX2_EmitOpReg(sctx, nm2, cdreg2+1);
		}else
		{
//			BGBCC_JX2_EmitOpImmReg(sctx, BGBCC_SH_NMID_MOV,
//				shl-32, cdreg2+0);
...
//				cdreg2+0, cdreg2+1);
			BGBCC_JX2C_EmitLeaShlRegImm(ctx, sctx, cdreg2+1, shl-32);
		}
	...
	if(shl<=3)
	{
		for(i=0; i<shl; i++)
		{
			BGBCC_JX2_EmitOpNone(sctx, BGBCC_SH_NMID_CLRT);
			BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_ADDC,
				cdreg2+0, cdreg2+0);
			BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_ADDC, 
				cdreg2+1, cdreg2+1);
		}
...
//	tr2=BGBCC_SH_REG_R0+(tr0&15);
	...
	tr1=BGBCC_JX2C_ScratchAllocReg(ctx, sctx, BGBCC_SH_REGCLS_GR);

	BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_MOV, cdreg2+0, tr0);
//	BGBCC_JX2_EmitOpImmReg(sctx, BGBCC_SH_NMID_MOV, shl, tr1);
//	BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_SHLD, tr1, cdreg2+0);
//	BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_SHLD, tr1, cdreg2+1);

	BGBCC_JX2C_EmitLeaShlRegImm(ctx, sctx, cdreg2+0, shl);
	BGBCC_JX2C_EmitLeaShlRegImm(ctx, sctx, cdreg2+1, shl);

//	BGBCC_JX2_EmitOpImmReg(sctx, BGBCC_SH_NMID_MOV, -(32-shl), tr1);
//	BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_SHLD, tr1, tr0);
	BGBCC_JX2C_EmitLeaShrRegImm(ctx, sctx, tr0, 32-shl);

	BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_OR, tr0, cdreg2+1);
...
int BGBCC_JX2C_EmitBinaryLong_ShrImm(
	BGBCC_TransState *ctx,
	BGBCC_JX2_Context *sctx,
	int cdreg, int shl)
{
...
//		if(nm1>=0)
		if(0)
		{
			BGBCC_JX2_EmitOpReg(sctx, nm1, cdreg2+0);
			if(nm2>=0)
				BGBCC_JX2_EmitOpReg(sctx, nm2, cdreg2+0);
		}else
		{
//			BGBCC_JX2_EmitOpImmReg(sctx, BGBCC_SH_NMID_MOV,
//				-(shl-32), cdreg2+1);
...
//				cdreg2+1, cdreg2+0);
			...
			BGBCC_JX2C_EmitLeaShrRegImm(ctx, sctx, cdreg2+0, shl-32);
		}
	...
	if(shl<=3)
	{
		...
		{
			BGBCC_JX2_EmitOpNone(sctx, BGBCC_SH_NMID_CLRT);
			BGBCC_JX2_EmitOpReg(sctx, BGBCC_SH_NMID_ROTCR, cdreg2+1);
			BGBCC_JX2_EmitOpReg(sctx, BGBCC_SH_NMID_ROTCR, cdreg2+0);
		}
		return(1);
	}
...
//	tr2=BGBCC_SH_REG_R0+(tr0&15);
	...
	BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_MOV, cdreg2+1, tr0);

//	BGBCC_JX2_EmitOpImmReg(sctx, BGBCC_SH_NMID_MOV, -shl, tr1);
//	BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_SHLD, tr1, cdreg2+0);
//	BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_SHLD, tr1, cdreg2+1);
	BGBCC_JX2C_EmitLeaShrRegImm(ctx, sctx, cdreg2+0, shl);
	BGBCC_JX2C_EmitLeaShrRegImm(ctx, sctx, cdreg2+1, shl);

//	BGBCC_JX2_EmitOpImmReg(sctx, BGBCC_SH_NMID_MOV, 32-shl, tr1);
//	BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_SHLD, tr1, tr0);
	BGBCC_JX2C_EmitLeaShlRegImm(ctx, sctx, tr0, 32-shl);

	BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_OR, tr0, cdreg2+0);
...
int BGBCC_JX2C_EmitBinaryLong_SarImm(
	BGBCC_TransState *ctx,
	BGBCC_JX2_Context *sctx,
	int cdreg, int shl)
{
	...
	if(shl>=63)
	{
//		BGBCC_JX2_EmitOpImmReg(sctx, BGBCC_SH_NMID_MOV, -31, cdreg2+0);
//		BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_SHAD, cdreg2+0, cdreg2+1);
		BGBCC_JX2C_EmitLeaSarRegImm(ctx, sctx, cdreg2+1, 31);
		BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_MOV, cdreg2+1, cdreg2+0);
		return(1);
	}
	...
	if(shl==32)
	{
		tr0=BGBCC_JX2C_ScratchAllocReg(ctx, sctx, BGBCC_SH_REGCLS_GR);
		BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_MOV, cdreg2+1, cdreg2+0);
//		BGBCC_JX2_EmitOpImmReg(sctx, BGBCC_SH_NMID_MOV, -31, tr0);
//		BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_SHAD, tr0, cdreg2+1);
		BGBCC_JX2C_EmitLeaSarRegImm(ctx, sctx, cdreg2+1, 31);
...
//		BGBCC_JX2_EmitOpImmReg(sctx, BGBCC_SH_NMID_MOV, -(shl-32), tr0);
//		BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_SHAD, tr0, cdreg2+0);
		BGBCC_JX2C_EmitLeaSarRegImm(ctx, sctx, cdreg2+0, shl-32);
...
//		tr0=BGBCC_JX2C_ScratchAllocReg(ctx, sctx, BGBCC_SH_REGCLS_GR);
		for(i=0; i<shl; i++)
		{
//			BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_ROTCR, cdreg2+1, tr0);
//			BGBCC_JX2_EmitOpReg(sctx, BGBCC_SH_NMID_ROTCL, tr0);
//			BGBCC_JX2_EmitOpReg(sctx, BGBCC_SH_NMID_ROTCR, cdreg2+1);
			BGBCC_JX2_EmitOpReg(sctx, BGBCC_SH_NMID_SHAR, cdreg2+1);
			BGBCC_JX2_EmitOpReg(sctx, BGBCC_SH_NMID_ROTCR, cdreg2+0);
		}
//		BGBCC_JX2C_ScratchReleaseReg(ctx, sctx, tr0);
		return(1);
...
//	BGBCC_JX2_EmitOpImmReg(sctx, BGBCC_SH_NMID_MOV, -shl, tr1);
//	BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_SHLD, tr1, cdreg2+0);
//	BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_SHAD, tr1, cdreg2+1);
	BGBCC_JX2C_EmitLeaShrRegImm(ctx, sctx, cdreg2+0, shl);
	BGBCC_JX2C_EmitLeaSarRegImm(ctx, sctx, cdreg2+1, shl);
...
int BGBCC_JX2C_EmitBinaryVRegVRegLong(
	BGBCC_TransState *ctx,
	BGBCC_JX2_Context *sctx,
	...
	int opr, ccxl_register treg)
{
	...
	if(nm1>=0)
	{
		...
		if((cdreg>=0) && (cdreg!=BGBCC_SH_REG_ZZR))
		{
			...
			{
				if(nm3>=0)
					BGBCC_JX2_EmitOpNone(sctx, nm3);
				BGBCC_JX2_EmitOpRegReg(sctx, nm1, ctreg+0, cdreg+0);
				BGBCC_JX2_EmitOpRegReg(sctx, nm2, ctreg+1, cdreg+1);
			...
			}else
			{
				...
				if(nm3>=0)
					BGBCC_JX2_EmitOpNone(sctx, nm3);
				BGBCC_JX2_EmitOpRegReg(sctx, nm1, BGBCC_SH_REG_R4, cdreg+0);
				BGBCC_JX2_EmitOpRegReg(sctx, nm2, BGBCC_SH_REG_R5, cdreg+1);
		...
		}else if((ctreg>=0) && (ctreg!=BGBCC_SH_REG_ZZR))
		{
			...
			if(nm3>=0)
				BGBCC_JX2_EmitOpNone(sctx, nm3);
			BGBCC_JX2_EmitOpRegReg(sctx, nm1, ctreg+0, BGBCC_SH_REG_R4);
			BGBCC_JX2_EmitOpRegReg(sctx, nm2, ctreg+1, BGBCC_SH_REG_R5);
		...
		if(nm4>=0)
		{
			BGBCC_JX2_EmitOpRegReg(sctx, nm4, BGBCC_SH_REG_R6, BGBCC_SH_REG_R6);
			BGBCC_JX2_EmitOpRegReg(sctx, nm4, BGBCC_SH_REG_R7, BGBCC_SH_REG_R7);
		}

		if(nm3>=0)
			BGBCC_JX2_EmitOpNone(sctx, nm3);
		BGBCC_JX2_EmitOpRegReg(sctx, nm1, BGBCC_SH_REG_R6, BGBCC_SH_REG_R4);
		BGBCC_JX2_EmitOpRegReg(sctx, nm2, BGBCC_SH_REG_R7, BGBCC_SH_REG_R5);
	...
	if(opr==CCXL_BINOP_MUL)
	{
		...
		BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_DMULU,
...
//		BGBCC_JX2C_EmitLoadVRegReg(ctx, sctx, treg, BGBCC_SH_REG_LR6);
		BGBCC_JX2_EmitLoadRegImm64P(sctx, BGBCC_SH_REG_LR6, lrcp);
...
//			BGBCC_SH_REG_R0, BGBCC_SH_REG_R3);
		...
		//Actual Results
		BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_DMULS,
...
//		BGBCC_JX2_EmitOpNone(sctx, BGBCC_SH_NMID_CLRT);
		...
		BGBCC_JX2_EmitOpImmReg(sctx, BGBCC_SH_NMID_MOV, 0, BGBCC_SH_REG_R0);
		BGBCC_JX2_EmitOpRegReg(sctx, BGBCC_SH_NMID_ADDC,
			BGBCC_SH_REG_R0, BGBCC_SH_REG_R3);
...
//	case CCXL_BINOP_SHR:	s0="__lli_shr"; break;
	...
	if((opr==CCXL_BINOP_SHL) && (shl>=0))
	{
		...
		i=BGBCC_JX2C_EmitBinaryLong_ShlImm(ctx, sctx, cdreg, shl);
		BGBCC_JX2C_EmitReleaseRegister(ctx, sctx, dreg);
		return(i);
	}
#endif
	...
	{
		cdreg=BGBCC_JX2C_EmitGetRegisterDirty(ctx, sctx, dreg);
		i=BGBCC_JX2C_EmitBinaryLong_ShrImm(ctx, sctx, cdreg, shl);
		BGBCC_JX2C_EmitReleaseRegister(ctx, sctx, dreg);
		return(i);
	}
#endif
	...
	{
		cdreg=BGBCC_JX2C_EmitGetRegisterDirty(ctx, sctx, dreg);
		i=BGBCC_JX2C_EmitBinaryLong_SarImm(ctx, sctx, cdreg, shl);
		BGBCC_JX2C_EmitReleaseRegister(ctx, sctx, dreg);
		return(i);
	}
#endif
	...
	if(s0)
	{
		...
		BGBCC_JX2C_EmitLoadVRegReg(ctx, sctx, treg, BGBCC_SH_REG_R6);
		BGBCC_JX2C_EmitLoadVRegReg(ctx, sctx, dreg, BGBCC_SH_REG_LR4);
		BGBCC_JX2C_EmitCallName(ctx, sctx, s0);
		BGBCC_JX2C_ScratchReleaseReg(ctx, sctx, BGBCC_SH_REG_LR4);
...
int BGBCC_JX2C_EmitBinaryVRegVRegVRegLong(
	BGBCC_TransState *ctx,
	BGBCC_JX2_Context *sctx,
	ccxl_type type, ccxl_register dreg,
	int opr,
	ccxl_register sreg, ccxl_register treg)
{
	...
	{
		i=BGBCC_JX2C_EmitBinaryVRegVRegLong(ctx, sctx, type, dreg, opr, treg);
		return(i);
	}
...
int BGBCC_JX2C_EmitUnaryVRegVRegLong(
	BGBCC_TransState *ctx,
	BGBCC_JX2_Context *sctx,
	ccxl_type type, ccxl_register dreg,
...
//		nm3=BGBCC_SH_NMID_CLRT;
	...
	if(nm1>=0)
	{
		...
		if((cdreg>=0) && (cdreg!=BGBCC_SH_REG_ZZR))
		{
			if((csreg>=0) && (csreg!=BGBCC_SH_REG_ZZR))
			{
				...
				BGBCC_JX2_EmitOpRegReg(sctx, nm1,
					csreg+0, cdreg+0);
				BGBCC_JX2_EmitOpRegReg(sctx, nm2,
					csreg+1, cdreg+1);
		...
		}else if((csreg>=0) && (csreg!=BGBCC_SH_REG_ZZR))
		{
			...
			if(nm3>=0)
				BGBCC_JX2_EmitOpNone(sctx, nm3);
			BGBCC_JX2_EmitOpRegReg(sctx, nm1, csreg+0, BGBCC_SH_REG_R4);
			BGBCC_JX2_EmitOpRegReg(sctx, nm2, csreg+1, BGBCC_SH_REG_R5);
		...
		if(nm3>=0)
			BGBCC_JX2_EmitOpNone(sctx, nm3);
		BGBCC_JX2_EmitOpRegReg(sctx, nm1, BGBCC_SH_REG_R4, BGBCC_SH_REG_R4);
		BGBCC_JX2_EmitOpRegReg(sctx, nm2, BGBCC_SH_REG_R5, BGBCC_SH_REG_R5);
...
int BGBCC_JX2C_EmitJCmpVRegVRegLong(
	BGBCC_TransState *ctx,
	BGBCC_JX2_Context *sctx,
	ccxl_type type,
	ccxl_register sreg, ccxl_register treg,
...
//			nm3=BGBCC_SH_NMID_CMPHS;	nm4=BGBCC_SH_NMID_BT;	fl3=0;
	...
	if((nm1>=0) && (nm2>=0))
	{
		...
		if(fl1)
			BGBCC_JX2_EmitOpRegReg(sctx, nm1, csreg+1, ctreg+1);
		else
			BGBCC_JX2_EmitOpRegReg(sctx, nm1, ctreg+1, csreg+1);
		BGBCC_JX2_EmitOpAutoLabel(sctx, nm2, l0);
		if(nm5>=0)
		{
			if(fl5)
				BGBCC_JX2_EmitOpRegReg(sctx, nm5, csreg+1, ctreg+1);
			else
				BGBCC_JX2_EmitOpRegReg(sctx, nm5, ctreg+1, csreg+1);
			BGBCC_JX2_EmitOpAutoLabel(sctx, nm6, l2);
		}

		if(fl3)
			BGBCC_JX2_EmitOpRegReg(sctx, nm3, csreg+0, ctreg+0);
		else
			BGBCC_JX2_EmitOpRegReg(sctx, nm3, ctreg+0, csreg+0);
		BGBCC_JX2_EmitOpAutoLabel(sctx, nm4, l1);

//		if(l0!=lbl)
//			BGBCC_JX2_EmitOpLabel(sctx, nm2, l0);
//		if(l1!=lbl)
//			BGBCC_JX2_EmitOpLabel(sctx, nm2, l1);
