...
int BGBCC_CCXL_CompileSwitchJmpR(BGBCC_TransState *ctx, ccxl_label *cl, s64 *clv, int clm, int cln, ccxl_label dfl);
...
int BGBCC_JX2_EmitCheckAutoLabelNear8(BGBCC_JX2_Context *ctx, int lbl);
int BGBCC_JX2_EmitCheckAutoLabelNear16B(BGBCC_JX2_Context *ctx, int lbl);
int BGBCC_JX2_EmitCheckAutoLabelNear24B(BGBCC_JX2_Context *ctx, int lbl);
