...
int BGBCC_JX2_EmitOpRegImmRegReg(BGBCC_JX2_Context *ctx,int nmid, int rs, int imm, int rp, int rn);
int BGBCC_JX2_ProbeEmitOpRegImmRegReg(BGBCC_JX2_Context *ctx,int nmid, int rs, int imm, int rp, int rn);
int BGBCC_JX2_TryEmitOpRegImmRegReg(BGBCC_JX2_Context *ctx, int nmid, int rs, int imm, int rp, int rn);
