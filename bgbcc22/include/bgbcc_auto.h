...
int BGBCC_JX2DA_EmitOpImmReg(BGBCC_JX2_Context *ctx,int nmid, int imm, int reg);
int BGBCC_JX2DA_EmitOpRegImmReg(BGBCC_JX2_Context *ctx,int nmid, int rm, int imm, int rn);
...
int BGBCC_JX2DA_EmitLoadRegImm(BGBCC_JX2_Context *ctx, int nmid, int reg, s32 imm);
int BGBCC_JX2DA_EmitLoadRegImm64(BGBCC_JX2_Context *ctx, int nmid, int reg, s32 imm);
...
int BGBCC_JX2_EmitOpCheckRepack(BGBCC_JX2_Context *ctx, int *ropw1, int *ropw2);
...
int BGBCC_JX2_EmitOpImmReg(BGBCC_JX2_Context *ctx,int nmid, int imm, int reg);
int BGBCC_JX2_ProbeEmitOpImmReg(BGBCC_JX2_Context *ctx,int nmid, int imm, int reg);
int BGBCC_JX2_TryEmitOpImmReg(BGBCC_JX2_Context *ctx,int nmid, int imm, int reg);
int BGBCC_JX2_EmitOpRegImmReg(BGBCC_JX2_Context *ctx,int nmid, int rm, int imm, int rn);
int BGBCC_JX2_ProbeEmitOpRegImmReg(BGBCC_JX2_Context *ctx,int nmid, int rm, int imm, int rn);
int BGBCC_JX2_TryEmitOpRegImmReg(BGBCC_JX2_Context *ctx, int nmid, int rm, int imm, int rn);
...
int BGBCC_JX2C_PackBlockLZ4_LookupMatch(BGBCC_TransState *ctx, byte *cs, byte *cse, int *rbl, int *rbd);
int BGBCC_JX2C_PackBlockLZ4_HashByte(BGBCC_TransState *ctx, byte *cs);
int BGBCC_JX2C_PackBlockLZ4_HashString(BGBCC_TransState *ctx, byte *cs, int sz);
int BGBCC_JX2C_PackBlockLZ4(BGBCC_TransState *ctx,byte *obuf, byte *ibuf, int obsz, int ibsz);
int BGBCC_JX2C_PackImagePEL4(BGBCC_TransState *ctx,byte *obuf, byte *ibuf, int obsz, int ibsz);
byte *BGBCC_TKPE_UnpackL4(byte *obuf, byte *ibuf, int isz);
int BGBCC_JX2C_VerifyImagePEL4(BGBCC_TransState *ctx,byte *obuf, byte *ibuf, int obsz, int ibsz);
