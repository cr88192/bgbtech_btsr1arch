...
BCCX_Node *BGBPP_PpiInterpDoFuncall2(BGBCP_ParseState *ctx,char *name, BCCX_Node **args, int nargs, BCCX_Node *extbody);
BCCX_Node *BGBPP_PpiInterpDoFuncall(BGBCP_ParseState *ctx,BGBPP_PpiDef *func, BCCX_Node *args, BCCX_Node *extbody);
...
int BGBCC_Img_EncodeImageDDS_DXTn(byte *obuf, byte *ibuf,int xs, int ys, int bcnfl);
...
//AHSRC:mm/cc_fmt_imgutil.c
int BGBCC_ImgUtil_DrawLine(byte *ibuf, int xs, int ys,int x0, int y0, int x1, int y1, u32 clr);
int BGBCC_ImgUtil_DrawGlyph(byte *ibuf, int xs, int ys,int xb, int yb, u64 pix, u32 clr);
int BGBCC_ImgUtil_DrawTextString(byte *ibuf, int xs, int ys,int xb, int yb, char *str, u32 clr);
int BGBCC_ImgUtil_DrawDenseHexDigit(byte *ibuf, int xs, int ys,int xb, int yb, byte dig, u32 clr);
int BGBCC_ImgUtil_ResampleImageLin(byte *ibuf, int ixs, int iys, byte *obuf, int oxs, int oys);
int BGBCC_ImgUtil_ResampleImage(byte *ibuf, int ixs, int iys, byte *obuf, int oxs, int oys);
int BGBCC_ImgUtil_CompositeBlendImage(byte *dstbuf, int dxs, int dys, byte *ibuf, int ixs, int iys, int obx, int oby, int oxs, int oys, u16 ang, int d_bf, int s_bf );
int BGBCC_ImgUtil_DrawFloodFillHorz(u32 *ibuf, int xs, int ys,int xc, int yc, u32 clr, u32 ref);
int BGBCC_ImgUtil_DrawFloodFill(byte *ibuf, int xs, int ys,int x0, int y0, u32 clr0);
...
void BGBCC_GenPalOpt4_SwapRB(byte *ibuf, int xs, int ys,byte *pal);
//AHSRC:mm/cc_fmt_wave.c
int BGBCC_WAVE_ParseHeader(byte *ibuf,int *rfofs, int *rfsz, int *rdofs, int *rdsz);
byte *BGBCC_WAVE_LoadWAV(byte *ibuf, int ibufsz,int *rch, int *rrt, int *rbts, int *rlen, int *rfmt, int *rblka);
short *BGBCC_WAVE_LoadWAV16(byte *ibuf, int ibufsz, int *rch, int *rrt, int *rlen);
short *BGBCC_WAVE_LoadWAV_Mono16(byte *ibuf, int ibufsz, int *rrt, int *rlen);
short *BGBCC_WAVE_LoadWAV_Stereo16(byte *ibuf, int ibufsz, int *rrt, int *rlen);
short *BGBCC_WAVE_LoadWAV_RateMono16(byte *ibuf, int ibufsz, int rate, int *rlen);
short *BGBCC_WAVE_LoadWAV_RateStereo16(byte *ibuf, int ibufsz, int rate, int *rlen);
...
int BGBCC_WAVE_StoreWaveFmtBlockI(byte *obuf, byte *ibuf, int ibsz, int wft, int ch, int rt, int bits, int len, int blksz, int realbits);
...
int BGBCC_WAVE_StoreWaveFmtBlockI(byte *obuf, byte *ibuf, int ibsz, int wft, int ch, int rt, int bits, int len, int blksz, int realbits);
void BGBCC_MsImaAdpcm_EncodeBlockMono2b_Opt(s16 *ibuf, byte *obuf, int len, int *rpred, int *ridx, int qfl);
void BGBCC_MsImaAdpcm_EncodeBlockMono4b_Opt(s16 *ibuf, byte *obuf, int len, int *rpred, int *ridx, int qfl);
int BGBCC_WAVE_StoreWaveImaAdpcm_Opt(byte *obuf, short *ibuf, int ch, int rt, int len, int qfl);
...
int BGBCC_WAVE_StoreWaveImaAdpcm2b_Opt(byte *obuf, short *ibuf, int ch, int rt, int len, int qfl);
...
int AD2B_SimDecodeN(s16 *obuf, int samp0, int idx0,u32 pat, int len, int *rsamp1, int *ridx1);
...
int AD2B_EncSimMsePatB(s16 *ibuf, int pred0, int idx0, u32 pat, int len,int *rpred1, int *ridx1);
int AD2B_EncBest8b(s16 *ibuf, int *rpred, int *ridx);
int AD2B_EncBestPat16b(s16 *ibuf, int *rpred, int *ridx);
void BGBCC_MsImaAdpcm_EncodeBlockMono2b_Opt(s16 *ibuf, byte *obuf, int len, int *rpred, int *ridx, int qfl);
int AD4B_SimDecodeN(s16 *obuf, int samp0, int idx0,u32 pat, int len, int *rsamp1, int *ridx1);
int AD4B_EncSimMsePatB(s16 *ibuf, int pred0, int idx0, u32 pat, int len,int *rpred1, int *ridx1);
...
int BGBCC_Img_EncodeImageBMP_LZ_4I(byte *obuf, byte *ibuf,int xs, int ys, byte *pal, int fl);
int BGBCC_Img_EncodeImageBMP_LZ_4(byte *obuf, byte *ibuf,int xs, int ys, byte *pal);
int BGBCC_Img_EncodeImageBMP_LZ_4A(byte *obuf, byte *ibuf,int xs, int ys, byte *pal);
...
int BGBCC_Img_EncodeImageBMP_BT5BI(byte *obuf, byte *ibuf,int xs, int ys, int fl);
int BGBCC_Img_EncodeImageBMP_BT5B(byte *obuf, byte *ibuf,int xs, int ys, int qfl);
...
int BGBCC_LoadConvResource_ImageCheckResize(byte **ribuf, int *rxs, int *rys, int tgt_xs, int tgt_ys);
...
int QOI_LossyCheckMatchRGBA(int cr0, int cg0, int cb0, int ca0, int cr1, int cg1, int cb1, int ca1, int errt);
int QOI_LossyCalcErrorRGBA(int cr0, int cg0, int cb0, int ca0, int cr1, int cg1, int cb1, int ca1);
int QOI_EncLiHash4LossyAlt(byte *cs, int errt, int errt_rcp, int alt);
int QOI_EncLiHash4Lossy(byte *cs, int errt, int errt_rcp);
int QOILZ_CheckMatchLossy(byte *str1, byte *str2, int nl, int errtb, int errtb_rcp, int *rterr);
...
int LCIF_EncodeAdjustYuvRangeBound(int *rmcy, int *rmcu, int *rmcv, int *rncy, int *rncu, int *rncv, u64 blk, int clrs);
...
int LCIF_LossyCheckMatchYUVA(int cr0, int cg0, int cb0, int ca0, int cr1, int cg1, int cb1, int ca1, int errt);
int LCIF_LossyCalcErrorYUVA(int cr0, int cg0, int cb0, int ca0, int cr1, int cg1, int cb1, int ca1);
...
void TKuPI_ClrTrans_ApxYUV(int cy, int cu, int cv, int *rcr, int *rcg, int *rcb);
void TKuPI_ClrTrans_YCoCgR(int cy, int cu, int cv, int *rcr, int *rcg, int *rcb);
void TKuPI_TransIYUV420(u16 *oimg, int ostr,s32 *iblky, s32 *iblku, s32 *iblkv, u16 *pimg);
void TKuPI_TransIY4(u16 *oimg, int ostr,s32 *iblky, u16 *pimg);
void TKuPI_TransIA4(u16 *oimg, int ostr, s32 *iblky,u16 *pimg);
void TKuPI_TransIYUV444(u16 *oimg, int ostr,s32 *iblky, s32 *iblku, s32 *iblkv, u16 *pimg);
void TKuPI_CopyTranslateMacroBlock(TKuPI_DecState *ctx,u16 *oimg, int ostr, byte *pimg, int pixs, int piys, int pixfmt, int mvx, int mvy);
void TKuPI_DecodeMacroBlockI(TKuPI_DecState *ctx,u16 *oimg, int ostr, byte *pimg, int pixs, int piys, int pixfmt);
void TKuPI_DecodeMacroBlock(TKuPI_DecState *ctx,byte *oimg, int ostr, byte *pimg, int pixs, int piys, int pixfmt);
void TKuPI_DecodeMacroBlockEdge(TKuPI_DecState *ctx,byte *oimg, byte *pimg, int ostr, int frxs, int frys, int pixfmt);
void TKuPI_DecodeMacroBlockBCN(TKuPI_DecState *ctx,u64 *oimg, int ostr, u64 *pimg, int frxs, int frys, int pixfmt);
int TKuPI_DecodeImageBufferI(TKuPI_DecState *ctx,byte *ibuf, int szibuf, byte *oimg, byte *pimg, int oxs, int oys, int pixfmt);
int TKuPI_DecodeImageBuffer(TKuPI_DecState *ctx,byte *ibuf, int szibuf, byte *oimg, int oxs, int oys);
int TKuPI_DecodeImageBufferH(TKuPI_DecState *ctx,byte *ibuf, int szibuf, u16 *oimg, int oxs, int oys);
...
void TKuPI_WriteCoeff(TKuPI_EncState *ctx,int v, int z, byte *rkf, byte *stfvtab, byte *stfitab);
...
void TKuPI_WriteBlockCoeffs(TKuPI_EncState *ctx,s32 *blk, u16 *qtab, s32 *rpdc);
...
void TKuPI_EClrTrans_ApxYUV(int cr, int cg, int cb, int *rcy, int *rcu, int *rcv);
void TKuPI_EClrTrans_YCoCgR(int cr, int cg, int cb, int *rcy, int *rcu, int *rcv);
void TKuPI_TransYUV420(u16 *img, int str,s32 *blky, s32 *blku, s32 *blkv);
void TKuPI_TransYUV444(u16 *img, int str,s32 *blky, s32 *blku, s32 *blkv);
...
void TKuPI_EncodeMacroBlockEdge(TKuPI_EncState *ctx,byte *img, int str, int frxs, int frys, int pixfmt);
void TKuPI_EncodeMacroBlock(TKuPI_EncState *ctx,byte *img, int str, int pixfmt);
int TKuPI_EncodeImageBuffer1I(TKuPI_EncState *ctx,byte *ibuf, int szibuf, byte *oimg, int oxs, int oys, int qfl, int pixfmt);
double TKuPI_EncCalcMseQbpp(byte *i1buf, byte *i2buf, int xs, int ys, int sz);
int TKuPI_EncodeImageBufferI(TKuPI_EncState *ctx,byte *ibuf, int szibuf, byte *oimg, int oxs, int oys, int qfl, int pixfmt);
int TKuPI_EncodeImageBuffer(TKuPI_EncState *ctx,byte *ibuf, int szibuf, byte *oimg, int oxs, int oys, int qfl);
...
int PDJPG_DecodeBasic(PDJPG_Context *ctx,byte *buf, int sz, int *rxs, int *rys);
byte *PDJPG_DecodeBasicNoCtxRGBA(byte *buf, int sz, int *rxs, int *rys);
...
int PDJPG_EncodeRgbaCtx(PDJPG_Context *ctx, byte *rgba, byte *obuf, int xs, int ys, int qf);
int PDJPG_EncodeClrsCtx(PDJPG_Context *ctx, byte *rgba, byte *obuf, int xs, int ys, int qf, int pf);
int PDJPG_EncodeRgba(byte *rgba, byte *obuf, int xs, int ys, int qf);
int PDJPG_EncodeClrs(byte *rgba, byte *obuf, int xs, int ys, int qf, int pf);
//AHSRC:mm/cc_fmt_dec_bt5bu.c
int BT5BU_InitTables();
int BT5BU_CalcLumaForRgb5(u16 v);
u64 BT5BU_DecodeEndpoint(byte **rcs, u64 eps0);
int BT5BU_DecodeImageData(byte *ibuf, int szibuf, u64 *blks, int nblks);
int BT5BU_DecodeFrameBlks(byte *cdat, int csz, u64 *blks, int nblks);
u64 BT5BU_ConvBlockToDXT1(u64 blk);
int BT5BU_DecodeFrameBlksDXT1(byte *cdat, int csz, u64 *blks, int nblks);
int BT5BU_DecodeFrameRGBA(byte *cdat, int csz, byte *obuf, int xs, int ys);
//AHSRC:mm/cc_fmt_enc_bt5bu.c
...
int BT5BU_QuantizeFrameBlks(u64 *blks, int nblks, int qfl);
...
int BT5BU_EncodeFrameBlks(byte *codat, int cosz, u64 *blks, int nblks);
u64 BT5BU_ConvBlockFromDXT1(u64 blk);
int BT5BU_EncodeFrameRGBA(byte *cobuf, int cosz, byte *ibuf, int xs, int ys, int qfl);
...
ccxl_status BGBCC_CCXL_EmitJmpTab(BGBCC_TransState *ctx,ccxl_type type, ccxl_register src, int clm, int cln, int clmw, ccxl_label *clbl, s64 *clv, s64 *clmv, ccxl_label dfl, ccxl_label dfl2);
...
ccxl_status BGBCC_CCXL_EmitLoadIndexAdjImm(BGBCC_TransState *ctx,ccxl_type type, ccxl_register dst, ccxl_register dstb, ccxl_register src, int idx, int adj);
...
ccxl_status BGBCC_CCXL_EmitZeroObj(BGBCC_TransState *ctx,ccxl_type type, ccxl_register dst, BGBCC_CCXL_LiteralInfo *st);
ccxl_status BGBCC_CCXL_EmitZeroArr(BGBCC_TransState *ctx,ccxl_type type, ccxl_register dst, int sz);
ccxl_status BGBCC_CCXL_EmitZeroObjArr(BGBCC_TransState *ctx,ccxl_type type, ccxl_register dst, BGBCC_CCXL_LiteralInfo *st, int sz);
...
int BGBCC_CCXL_CompileSwitchJmpR(BGBCC_TransState *ctx, ccxl_label *cl, s64 *clv, s64 *clmv, int clm, int cln, int clmw, ccxl_label dfl, ccxl_label dfl2);
int BGBCC_CCXL_CompileSwitch_SortR(BGBCC_TransState *ctx, ccxl_label *cl, s64 *clv, s64 *clmv, int clm, int cln);
...
ccxl_status BGBCC_CCXL_StackCompileJmpTab(BGBCC_TransState *ctx,int clm, int cln, int clmw, ccxl_label *clbl, s64 *clv, s64 *clmv, ccxl_label dfl, ccxl_label dfl2);
...
ccxl_status BGBCC_CCXL_GetRegForTristateValue(BGBCC_TransState *ctx, ccxl_register *rreg, s64 val_lo, s64 val_hi, int val_sz);
ccxl_status BGBCC_CCXL_GetRegForUBitIntValue(BGBCC_TransState *ctx, ccxl_register *rreg, s64 val, int val_sz);
ccxl_status BGBCC_CCXL_GetRegForUBitInt128Value(BGBCC_TransState *ctx, ccxl_register *rreg, s64 val_lo, s64 val_hi, int val_sz);
ccxl_status BGBCC_CCXL_GetRegForSBitInt128Value(BGBCC_TransState *ctx, ccxl_register *rreg, s64 val_lo, s64 val_hi, int val_sz);
ccxl_status BGBCC_CCXL_GetRegForSBitIntValue(BGBCC_TransState *ctx, ccxl_register *rreg, s64 val, int val_sz);
...
ccxl_status BGBCC_CCXL_StackLoadPostAdjNameI(BGBCC_TransState *ctx, int idx, int adj, char *name);
ccxl_status BGBCC_CCXL_StackLoadPostAdjNameStoreI(BGBCC_TransState *ctx, int idx, int adj, char *name, char *dstname);
ccxl_status BGBCC_CCXL_StackLoadPostAdjName(BGBCC_TransState *ctx, int idx, int adj, char *name);
ccxl_status BGBCC_CCXL_StackLoadPostAdjNameStore(BGBCC_TransState *ctx, int idx, int adj, char *name, char *dstname);
ccxl_status BGBCC_CCXL_StackStorePostAdjName(BGBCC_TransState *ctx, int idx, int adj, char *name);
ccxl_status BGBCC_CCXL_StackLoadPostIncName(BGBCC_TransState *ctx, int idx, char *name);
ccxl_status BGBCC_CCXL_StackLoadPostDecName(BGBCC_TransState *ctx, int idx, char *name);
ccxl_status BGBCC_CCXL_StackLoadPostIncNameStore(BGBCC_TransState *ctx, int idx, char *name, char *dstname);
ccxl_status BGBCC_CCXL_StackLoadPostDecNameStore(BGBCC_TransState *ctx, int idx, char *name, char *dstname);
ccxl_status BGBCC_CCXL_StackStorePostIncName(BGBCC_TransState *ctx, int idx, char *name);
ccxl_status BGBCC_CCXL_StackStorePostDecName(BGBCC_TransState *ctx, int idx, char *name);
...
bool BGBCC_CCXL_TypeSmallFQuatP(BGBCC_TransState *ctx, ccxl_type ty);
bool BGBCC_CCXL_TypeSmallDQuatP(BGBCC_TransState *ctx, ccxl_type ty);
...
ccxl_status BGBCC_CCXL_TypeVectorOfType(BGBCC_TransState *ctx, ccxl_type sty, int sz, ccxl_type *rdty);
...
u32 BGBCC_CCXL_TypeAsCanonical(BGBCC_TransState *ctx, ccxl_type sty);
...
int BGBCC_CCXL_TypeCompatibleBothPointerP(BGBCC_TransState *ctx, ccxl_type dty, ccxl_type sty);
...
int BGBCC_JX2A_LookupOpcodeMfl(BGBCC_JX2_Context *ctx, char *name);
...
int BGBCC_JX2_ComposeJumboRegImm57sRegF2(BGBCC_JX2_Context *ctx,int *ropw1, int *ropw2, int *ropw3, int *ropw4, int *ropw5, int *ropw6, int topw1, int topw2, int sreg, s64 imm, int dreg);
...
int BGBCC_JX2_ComposeJumboRegImm24RegRegF0(BGBCC_JX2_Context *ctx,int *ropw1, int *ropw2, int *ropw3, int *ropw4, int topw1, int topw2, int sreg, s64 imm, int preg, int dreg);
...
int BGBCC_JX2_EmitCheckAutoLabelNear6_X3(BGBCC_JX2_Context *ctx, int lbl, int nmid);
...
int BGBCC_JX2_TryNormalizeFXReg(BGBCC_JX2_Context *ctx, int nmid, int rs0);
...
int BGBCC_JX2RV_CheckRepackRVC(BGBCC_JX2_Context *ctx, s64 *ropw1, s64 *ropw2);
int BGBCC_JX2RV_CheckOp32IsImm12Alu(BGBCC_JX2_Context *ctx, u32 opw);
int BGBCC_JX2RV_CheckNoAliasOp32(BGBCC_JX2_Context *ctx, u32 opw1, u32 opw2);
int BGBCC_JX2RV_TryEncJumboOpXRegImm12XReg(BGBCC_JX2_Context *ctx, int rm, s64 imm, int rn, s64 opwb, s64 *ropw1, s64 *ropw2);
int BGBCC_JX2RV_TryEncJumbo96OpXRegImm12XReg(BGBCC_JX2_Context *ctx, int rm, s64 imm, int rn, s64 opwb, s64 *ropw1, s64 *ropw2, s64 *ropw3);
int BGBCC_JX2RV_TryEncJumboOpXRegImm12XReg_J33Only(BGBCC_JX2_Context *ctx, int rm, s64 imm, int rn, s64 opwb, s64 *ropw1, s64 *ropw2);
...
int BGBCC_JX2RV_TryEncJumbo96OpXRegDisp12StXReg(BGBCC_JX2_Context *ctx, int rm, s64 imm, int rn, s64 opwb, s64 *ropw1, s64 *ropw2, s64 *ropw3);
...
int BGBCC_JX2RV_TryEncJumboSubOpXRegImmRoXReg(BGBCC_JX2_Context *ctx, int rm, s64 iro, int rn, s64 opwb, int sub, s64 *ropw1, s64 *ropw2);
...
int BGBCC_JX2RV_EmitOpRegRegLbl(BGBCC_JX2_Context *ctx,int nmid, int rm, int rn, int lbl);
...
int BGBCC_JX2X3_CheckRepack4(BGBCC_JX2_Context *ctx, s64 *ropw1, s64 *ropw2, s64 *ropw3, s64 *ropw4);
int BGBCC_JX2X3_CheckEncodeRIRJ_Imm10I(BGBCC_JX2_Context *ctx, s64 opwb, int rm, s64 imm, int rn, s64 *ropw1, s64 *ropw2, s64 *ropw3);
int BGBCC_JX2X3_CheckEncodeRIRJ_Imm10sB(BGBCC_JX2_Context *ctx, s64 opwb, int rm, s64 imm, int rn, s64 *ropw1, s64 *ropw2, s64 *ropw3);
int BGBCC_JX2X3_CheckEncodeRIRJ_Imm10s(BGBCC_JX2_Context *ctx, s64 opwb, int rm, s64 imm, int rn, s64 *ropw1, s64 *ropw2);
int BGBCC_JX2X3_CheckEncodeRIRJ_Imm10uB(BGBCC_JX2_Context *ctx, s64 opwb, int rm, s64 imm, int rn, s64 *ropw1, s64 *ropw2, s64 *ropw3);
...
int BGBCC_JX2X3_CheckEncodeRIRJ_Imm9uB(BGBCC_JX2_Context *ctx, s64 opwb, int rm, s64 imm, int rn, s64 *ropw1, s64 *ropw2, s64 *ropw3);
...
ccxl_status BGBCC_JX2C_FlattenImage_CompareGlobalsBasic(BGBCC_TransState *ctx, int idx1, int idx2);
ccxl_status BGBCC_JX2C_FlattenImage_CompareGlobalsProp(BGBCC_TransState *ctx, int idx1, int idx2);
ccxl_status BGBCC_JX2C_FlattenImage_SortGlobalsCmpR(BGBCC_TransState *ctx, int *shufarr, int shufgbl, int rec, int (*compare)(BGBCC_TransState *ctx, int idx1, int idx2));
ccxl_status BGBCC_JX2C_FlattenImage_SortGlobals(BGBCC_TransState *ctx, int *shufarr, int shufgbl);
ccxl_status BGBCC_JX2C_FlattenImage_ShuffleGlobals(BGBCC_TransState *ctx, int *shufarr, int shufgbl);
ccxl_status BGBCC_JX2C_FlattenImage_ShufCompactGlobals(BGBCC_TransState *ctx, int *shufarr, int shufgbl);
...
int BGBCC_JX2C_MergeGlobalSetMask(BGBCC_TransState *ctx,BGBCC_JX2_Context *sctx, BGBCC_CCXL_RegisterInfo *dobj, BGBCC_CCXL_RegisterInfo *sobj);
int BGBCC_JX2C_InvalidateGlobalSetMask(BGBCC_TransState *ctx,BGBCC_JX2_Context *sctx, BGBCC_CCXL_RegisterInfo *dobj);
int BGBCC_JX2C_MarkGlobalSetMask(BGBCC_TransState *ctx,BGBCC_JX2_Context *sctx, BGBCC_CCXL_RegisterInfo *obj, ccxl_register reg);
...
ccxl_status BGBCC_JX2C_Prolog_VopSetupReturnLabel(BGBCC_TransState *ctx,BGBCC_JX2_Context *sctx, BGBCC_CCXL_RegisterInfo *obj, BGBCC_CCXL_VirtOp *op);
...
int BGBCC_JX2C_EmitLdix_RemapConvNmidForStore(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, int nm2);
...
int BGBCC_JX2C_EmitLdixAdjVRegVRegImm(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, ccxl_type type, ccxl_type stype, ccxl_register dreg, ccxl_register dregb, ccxl_register sreg, s32 idx, s32 adj);
int BGBCC_JX2C_EmitStixAdjVRegVRegImm(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, ccxl_type type, ccxl_type stype, ccxl_register dreg, ccxl_register dregb, ccxl_register sreg, s32 idx, int adj);
...
int BGBCC_JX2C_EmitBitMovVRegVRegVRegQLong(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, ccxl_type type, ccxl_register dreg, ccxl_register sreg, ccxl_register treg, int mshl, int mlo, int mhi);
...
int BGBCC_JX2C_GetRqRegStructReturn(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx);
...
int BGBCC_JX2C_CheckRegisterIndexExcludeP(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, int idx, int isfpu);
...
int BGBCC_JX2C_EmitGetRegisterSniffReg(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, int creg);
...
int BGBCC_JX2C_EmitBindVRegRegDirty(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, ccxl_register reg, int dreg);
int BGBCC_JX2C_GetRegisterIndexForReg(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, int dreg);
...
int BGBCC_JX2C_CheckVRegMoreUsesInTraceStepP(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, ccxl_register reg, int step);
int BGBCC_JX2C_CheckVRegMoreUsesInTraceP(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, ccxl_register reg);
int BGBCC_JX2C_CheckVRegConsumeNextOpP(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, ccxl_register reg);
int BGBCC_JX2C_CheckVRegCrossTraceP(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, ccxl_register reg);
int BGBCC_JX2C_ProbeVRegInRegisterP(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, ccxl_register reg);
int BGBCC_JX2C_ProbeVRegInRegisterActiveP(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, ccxl_register reg);
int BGBCC_JX2C_ProbeVRegIsCallArgP(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, ccxl_register reg);
int BGBCC_JX2C_ProbeVRegRejectImm3P(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, ccxl_register dreg, ccxl_register sreg, ccxl_register treg, int nm);
...
int BGBCC_JX2C_EmitSyncAliasRegisters(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx);
...
int BGBCC_JX2C_EmitLoadSlotAndIndexVRegVRegImm2(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, ccxl_type type, ccxl_register dreg, ccxl_register sreg, int gblid, int fid, int idx);
...
int BGBCC_JX2C_EmitMemset64Autogen(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx);
...
int BGBCC_JX2C_EmitValueNonZeroRegSz(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, int dreg, int val, int sz, int al);
int BGBCC_JX2C_EmitZeroArr(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, ccxl_type type, ccxl_register dreg, int asz);
...
int BGBCC_JX2C_EmitBitMovVRegVRegVReg(BGBCC_TransState *ctx, BGBCC_JX2_Context *sctx, ccxl_type type, ccxl_register dreg, ccxl_register sreg, ccxl_register treg, int mshl, int mlo, int mhi);
...
int BGBCC_JX2_CheckOps32UpdatesSrTp(BGBCC_JX2_Context *sctx, int opw1, int opw2);
...
//AHSRC:jx2cc/jx2_x3wexify.c
int BGBCC_JX2_CheckOpsX3_GetRegsImm(BGBCC_JX2_Context *sctx, u32 opw, u16 *rrs, u16 *rrt, u16 *rrn, u16 *rrp, u16 *rspr, u16 *rspw, int *rspfl, s64 *rimm);
int BGBCC_JX2_CheckOpsRv_GetRegs(BGBCC_JX2_Context *sctx, u32 opw, u16 *rrs, u16 *rrt, u16 *rrn, u16 *rrp, u16 *rspr, u16 *rspw, int *rspfl);
int BGBCC_JX2_CheckOpsRv_GetRegsImm(BGBCC_JX2_Context *sctx, u32 opw, u16 *rrs, u16 *rrt, u16 *rrn, u16 *rrp, u16 *rspr, u16 *rspw, int *rspfl, s64 *rimm);
int BGBCC_JX2_CheckOpsRv_IsMem(BGBCC_JX2_Context *sctx, u32 opw);
int BGBCC_JX2_CheckOpsRv_IsLoad(BGBCC_JX2_Context *sctx, u32 opw);
int BGBCC_JX2_CheckOpsRv_Is2Stage(BGBCC_JX2_Context *sctx, u32 opw);
int BGBCC_JX2_CheckOpsRv_Is3Stage(BGBCC_JX2_Context *sctx, u32 opw);
int BGBCC_JX2_CheckOpsRv_IsFixed(BGBCC_JX2_Context *sctx, u32 opw);
int BGBCC_JX2_CheckOpsRv_IsJumbo64(BGBCC_JX2_Context *sctx, u32 opw);
int BGBCC_JX2_CheckOpsRv_IsJumbo96(BGBCC_JX2_Context *sctx, u32 opw0, u32 opw1);
int BGBCC_JX2_CheckOpsRv_IsLane2(BGBCC_JX2_Context *sctx, u32 opw);
int BGBCC_JX2_CheckOpsRv_MemNoAlias(BGBCC_JX2_Context *sctx, u32 opw1, u32 opw2, int fl);
int BGBCC_JX2_CheckOpsRv_SequenceOnlyB(BGBCC_JX2_Context *sctx, u32 opw1, u32 opw2, int fl);
int BGBCC_JX2_InferOpsRv_Interlock(BGBCC_JX2_Context *sctx, int opw1, int opw2, int opw3, int fl);
int BGBCC_JX2_InferOpsRv_InterlockEx2(BGBCC_JX2_Context *sctx, int opw1, int opw2, int opw3, int opw4, int opw5, int fl);
int BGBCC_JX2_InferOpsRv_InterlockI(BGBCC_JX2_Context *sctx, u32 opw1, u32 opw2, u32 opw3, int fl);
int BGBCC_JX2_CheckOpsRv_Immovable(BGBCC_JX2_Context *sctx, u32 opw);
int BGBCC_JX2_CheckOpsRv_ImmovableFl(BGBCC_JX2_Context *sctx, u32 opw, int flag);
int BGBCC_JX2_CheckOpsRv_SequenceOnly(BGBCC_JX2_Context *sctx, u32 opw1, u32 opw2);
int BGBCC_JX2_CheckOpsRv_CanSwap(BGBCC_JX2_Context *sctx, u32 opw1, u32 opw2);
int BGBCC_JX2_CheckOpsRv_CanSwapOrJ(BGBCC_JX2_Context *sctx, u32 opw1, u32 opw2);
int BGBCC_JX2_CheckOpsRv_InferInterlockCost(BGBCC_JX2_Context *sctx, u32 opwn7, u32 opwn5, u32 opwn3, u32 opwn1, u32 opw1, u32 opw3, u32 opw5, u32 opw7, u32 opw9, u32 opw11, u32 opw13, u32 opw15);
...
ccxl_status BGBCC_JX2_OptX3Interlock_DoSwaps(BGBCC_JX2_Context *sctx, int spos, int epos);
ccxl_status BGBCC_JX2_CheckX3Wexify_DoSwaps(BGBCC_JX2_Context *sctx, int spos, int epos);
ccxl_status BGBCC_JX2_CheckX3Wexify(BGBCC_JX2_Context *sctx, int spos, int epos);
...
BTM_CsgBrush *BTM_AllocBrushCylinder(float *org, float zhgt, float ratbot, float rattop, int fn);
BTM_CsgBrush *BTM_AllocBrushSphere(float rad, int fn);
BTM_CsgBrush *BTM_AllocBrushSphereScale(float *org, float *size, int fn);
...
BTM_CsgPoly *BTM_MakeCsgPolyForPointsF(float *pts, int npts, u64 clrmat, BTM_CsgPoly *lst);
BTM_CsgPoly *BTM_MakeCsgPolyForPointsD(double *pts, int npts, u64 clrmat, BTM_CsgPoly *lst);
...
BTM_CsgPoly *BTM_ClipCsgPolysByBrush(BTM_CsgBrush *bru,BTM_CsgPoly *orglst, float *trans, int flag);
BTM_CsgPoly *BTM_ClipCsgPolysOutsideByBrushList(BTM_CsgBrush *brulst, BTM_CsgPoly *plylst, float *trans);
BTM_CsgPoly *BTM_ClipCsgPolysInsideByBrushList(BTM_CsgBrush *brulst, BTM_CsgPoly *plylst, float *trans);
...
BTM_CsgPoly *BTM_ClipCsgPolysForCsgNode(BTM_CsgNode *tree,BTM_CsgPoly *orglst, float *trans, int flag);
BTM_CsgPoly *BTM_GetCsgPolysForCsgNode(BTM_CsgNode *tree,BTM_CsgPoly *orglst, float *trans, u64 iclrmat, int flag);
//AHSRC:csg/btm_csg_clip.c
int HullF_LinePlaneIntersect(float *start, float *end,float *norm, float *point);
int HullF_LinePlaneIntersectST(float *sv, float *sst,float *ev, float *est, float *norm, float *ov, float *ost);
int HullF_LinePlaneIntersectSTNVRGBA(float *norm, float *sv, float *sst, float *snv, float *sclr, float *ev, float *est, float *env, float *eclr, float *ov, float *ost, float *onv, float *oclr, int flags);
void HullF_AdjacentNormals(float *norm, float *udir, float *vdir);
void HullF_AdjacentNormals2(float *norm, float *udir, float *vdir);
void HullF_AdjacentNormals21(float *norm, float *udir, float *vdir);
void HullF_AdjacentNormals22(float *norm, float *udir, float *vdir);
void HullF_AdjacentNormals23(float *norm, float *udir, float *vdir);
void HullF_MakePlaneFace(float *norm, float *pts);
int HullF_ClipFace(float *norm,float *ipts, float *opts, int num);
int HullF_ClipFaceST(float *norm,float *ipts, float *ist, float *opts, float *ost, int num);
int HullF_ClipFaceSTNVRGBA(float *norm,int xyzsz, int stsz, int nvsz, int clrsz, float *ipts, float *ist, float *inv, float *iclr, float *opts, float *ost, float *onv, float *oclr, int num, int flags);
void HullF_BoxPlaneExtents(float *mins, float *maxs, float *norm, float *rm, float *rn);
void HullF_SpherePlaneExtents(float *org, float rad, float *norm, float *rm, float *rn);
void HullF_PolyPlaneExtents(float *pts, int npts, float *norm, float *rm, float *rn);
void HullF_CalcPolyBBox(float *pts, int npts, float *rmins, float *rmaxs);
void HullF_MakePlaneFace(float *norm, float *pts);
int HullF_ClipFace(float *norm,float *ipts, float *opts, int num);
...
void HullD_AdjacentNormals2(double *norm, double *udir, double *vdir);
int HullD_LinePlaneIntersect(double *start, double *end,double *norm, double *point);
void HullD_MakePlaneFace(double *norm, double *pts);
int HullD_ClipFace(double *norm,double *ipts, double *opts, int num);
void HullD_PolyPlaneExtents(double *pts, int npts, double *norm, double *rm, double *rn);
//AHSRC:csg/btm_fmtobj.c
int BTM_ObjGetVertex(float **rvtxbuf, int *rpos, float *vec);
int BTM_ObjDumpTrisBuf(char **robuf, int *robsz, float **vtxbuf, int *vtxpos, char *sldname, float *tris, int ntris, u32 clr);
int BTM_ExportMeshListObjBuf(BTM_SolidMesh *mesh,byte **robuf, int *robsz);
//AHSRC:csg/btm_fmtstl.c
...
int BTM_Mesh_TrisEmitTriangle(float **rtris, u16 **rrgb5, int *rntris,btm_vec3f v0, btm_vec3f v1, btm_vec3f v2, u16 clr);
int BTM_Mesh_TrisEmitQuad(float **rtris, u16 **rrgb5, int *rntris,btm_vec3f v0, btm_vec3f v1, btm_vec3f v2, btm_vec3f v3, u16 clr);
int BTM_Mesh_TrisEmitPentagon(float **rtris, int *rntris,btm_vec3f v0, btm_vec3f v1, btm_vec3f v2, btm_vec3f v3, btm_vec3f v4);
int BTM_Mesh_TrisEmitHexagon(float **rtris, int *rntris,btm_vec3f v0, btm_vec3f v1, btm_vec3f v2, btm_vec3f v3, btm_vec3f v4, btm_vec3f v5);
int BTM_Mesh_TrisEmitHeptagon(float **rtris, int *rntris,btm_vec3f v0, btm_vec3f v1, btm_vec3f v2, btm_vec3f v3, btm_vec3f v4, btm_vec3f v5, btm_vec3f v6);
int BTM_Mesh_TrisEmitOctagon(float **rtris, int *rntris,btm_vec3f v0, btm_vec3f v1, btm_vec3f v2, btm_vec3f v3, btm_vec3f v4, btm_vec3f v5, btm_vec3f v6, btm_vec3f v7);
int BTM_Mesh_TrisEmitPolygon(float **rtris, u16 **rrgb5, int *rntris,float *vec, int npts, u16 clr);
int BTM_DumpTrisRawBuf(char **robuf, float *tris, int ntris);
int BTM_DumpTrisStlBuf(char **robuf, int *robsz,char *sldname, float *tris, int ntris);
int BTM_ExportMeshListStlBuf(BTM_SolidMesh *mesh,byte **robuf, int *robsz);
int BTM_DumpTrisBinStlBuf(char **robuf, int *robsz,char *sldname, float *tris, int ntris, u16 clr5);
int BTM_ExportMeshListBinStlBuf(BTM_SolidMesh *mesh,byte **robuf, int *robsz);
int btm_bufgets(char *dst, int max, char **rcs);
int BTM_LoadTrisStlAsciiBuf(byte *sbuf,float **rtris, u16 **rrgb5, int *rntris);
...
BTM_SolidSkel *BTM_LoadBonesI(BTM_SolidSkel *skel, char *fname);
...
u32 BTM_BmdLoad_InterpolatePackQuat32(u32 val0, u32 val1, int ix0, int ix1, int ixd, int ixn);
u32 BTM_BmdLoad_InterpolatePackSe32(u32 val0, u32 val1, int ix0, int ix1, int ixd, int ixn);
u32 BTM_GetColorRgbForBlockLight(byte val);
byte BTM_GetBlockLightForRgb(u32 rgb);
int BTM_BmdLoad_DecodeVertex(byte *buf, int vsz, u32 baseclr,float *xy, float *st, float *nv, u32 *cl, byte *bn);
int BTM_BmdLoad_DecodeTriQuad(byte *buf, int tsz,u16 *vidx);
int BTM_BmdLoad_DecodeAnimFrames(BTM_BtModel *mdl, BTM_BtModelAnim *anim, byte *buf);
...
u32 BTM_BmdScaleRgbFp(u32 src, float f);
u32 BTM_BmdScaleRgbFp3(u32 src, float fr, float fg, float fb);
int BTM_BmdGetModelCacheVertexTransIdx(BTM_BtModel *mdl,int midx, int seq, int frm);
...
int BTM_BmdDrawInit();
int BTM_BmdCheckLineCrossFace(BTM_BtModelMesh *mesh, int fn,float *spos, float *epos);
...
BTM_SolidMesh *BTM_LookupMeshList(BTM_SolidMesh *lst, char *name);
int BTM_DeleteMesh(char *name);
int BTM_TransformMesh(BTM_SolidMesh *mesh, float *mat);
int BTM_InvertMesh(BTM_SolidMesh *mesh,float x, float y, float z);
int BTM_ProjectMeshAxis(BTM_SolidMesh *mesh,btm_vec3f vec, float *rm, float *rn);
int BTM_ProjectMeshAxisPlane(BTM_SolidMesh *mesh, btm_vec4f plane, float *rm, float *rn);
btm_vec4f BTM_CalcTrianglePlane(btm_vec3f v0, btm_vec3f v1, btm_vec3f v2);
btm_vec3f BTM_LinePlaneIntersect(btm_vec4f pl, btm_vec3f vs, btm_vec3f ve);
void BTM_CalcTrianglePlaneExtents(btm_vec4f pl, btm_vec3f v0, btm_vec3f v1, btm_vec3f v2, float *rm, float *rn);
int BTM_CheckTriangleLine(btm_vec3f v0, btm_vec3f v1, btm_vec3f v2, btm_vec3f vs, btm_vec3f ve, float rad);
int BTM_CheckTriangleTriangleA(btm_vec3f v0, btm_vec3f v1, btm_vec3f v2, btm_vec3f v0b, btm_vec3f v1b, btm_vec3f v2b);
int BTM_CheckTriangleTriangle(btm_vec3f v0a, btm_vec3f v1a, btm_vec3f v2a, btm_vec3f v0b, btm_vec3f v1b, btm_vec3f v2b);
int BTM_ClipFace(btm_vec4f norm,btm_vec3f *ipts, btm_vec3f *opts, int num);
int BTM_MeshCheckLineCrossings(BTM_SolidMesh *mesh,btm_vec3f vs, btm_vec3f ve, float rad);
int BTM_MeshIsConvexP(BTM_SolidMesh *mesh);
int BTM_CheckSphereInMeshConvexP(BTM_SolidMesh *mesh,btm_vec3f org, float rad);
int BTM_CheckSphereInMeshP(BTM_SolidMesh *mesh,btm_vec3f org, float rad);
int BTM_CheckTriangleInMeshP(BTM_SolidMesh *mesh,btm_vec3f v0, btm_vec3f v1, btm_vec3f v2);
int BTM_RebuildMesh_GetVertexIndexBuf(float **rxy, float **rst, float **rnv, int *rnvtx, int *rmvtx, float *vxy, float *vst, float *vnv);
...
int BTM_MeshBufferSetVertex128B(byte **robuf, int ofs,float *xyz, float *st, float *nv, u32 rgb, int bone);
int BTM_MeshBufferSetVertex64A(byte **robuf, int ofs,float *xyz, float *st, float *nv, u32 rgb, int bone);
int BTM_MeshBufferSetVertex64B(byte **robuf, int ofs,float *xyz, float *st, float *nv, u32 rgb, int bone);
int BTM_MeshBufferSetVertex96A(byte **robuf, int ofs,float *xyz, float *st, float *nv, u32 rgb, int bone);
int BTM_MeshBufferSetTriangle64(byte **robuf, int ofs,int *vidx);
int BTM_MeshBufferSetTriangle32(byte **robuf, int ofs,int *vidx);
int BTM_ExportMeshListBmdBuf(BTM_SolidMesh *mesh,byte **robuf, int *robsz);
int BTM_ExportMeshListBmd(char *fname, BTM_SolidMesh *mesh);
//AHSRC:csg/btm_pgmvar.c
...
int BTM_PgmDoEvalCommaList(BTM_ProgCtx *wrl, BTM_ConPgm *pgm,u16 **rtcs, u64 *args);
int BTM_PgmDoEvalArgsList(BTM_ProgCtx *wrl, BTM_ConPgm *pgm,u16 **rtcs, u64 *args);
int BTM_PgmDoEvalNamedArgsList(BTM_ProgCtx *wrl, BTM_ConPgm *pgm,u16 **rtcs, u16 *argn, u64 *argv);
...
//AHSRC:csg/btm_scad.c
BCCX_Node *BTM_ScadPPI_InterpBody(BGBCP_ParseState *ctx, BCCX_Node *lst);
void BTM_ScadPPI_InterpUnwrapVec4(BGBCP_ParseState *ctx,BCCX_Node *n, double *vec);
u32 BTM_ScadPPI_InterpSanitizeColor(u32 clr);
u32 BTM_ScadPPI_InterpUnwrapColor(BGBCP_ParseState *ctx, BCCX_Node *n);
BCCX_Node *BTM_ScadPPI_Translate(BGBCP_ParseState *ctx,BGBPP_PpiDef *func, BCCX_Node **args, int nargs, BCCX_Node *ext);
BCCX_Node *BTM_ScadPPI_Scale(BGBCP_ParseState *ctx,BGBPP_PpiDef *func, BCCX_Node **args, int nargs, BCCX_Node *ext);
BCCX_Node *BTM_ScadPPI_Rotate(BGBCP_ParseState *ctx,BGBPP_PpiDef *func, BCCX_Node **args, int nargs, BCCX_Node *ext);
BCCX_Node *BTM_ScadPPI_Color(BGBCP_ParseState *ctx,BGBPP_PpiDef *func, BCCX_Node **args, int nargs, BCCX_Node *ext);
BCCX_Node *BTM_ScadPPI_Cube(BGBCP_ParseState *ctx,BGBPP_PpiDef *func, BCCX_Node **args, int nargs, BCCX_Node *ext);
BCCX_Node *BTM_ScadPPI_Cylinder(BGBCP_ParseState *ctx,BGBPP_PpiDef *func, BCCX_Node **args, int nargs, BCCX_Node *ext);
BCCX_Node *BTM_ScadPPI_Sphere(BGBCP_ParseState *ctx,BGBPP_PpiDef *func, BCCX_Node **args, int nargs, BCCX_Node *ext);
BCCX_Node *BTM_ScadPPI_Union(BGBCP_ParseState *ctx,BGBPP_PpiDef *func, BCCX_Node **args, int nargs, BCCX_Node *ext);
BCCX_Node *BTM_ScadPPI_Difference(BGBCP_ParseState *ctx,BGBPP_PpiDef *func, BCCX_Node **args, int nargs, BCCX_Node *ext);
BCCX_Node *BTM_ScadPPI_Intersection(BGBCP_ParseState *ctx,BGBPP_PpiDef *func, BCCX_Node **args, int nargs, BCCX_Node *ext);
...
void TKRA_Mat4F_SetupFrustum(float *mat,float left, float right, float bottom, float top, float nearval, float farval);
void TKRA_Mat4F_SetupOrtho(float *mat,float left, float right, float bottom, float top, float nearval, float farval);
...
void TKRA_Vec3D_AddScale(double *a, double *b, double s, double *c);
void TKRA_Vec3D_ScaleAddScale(double *a, double t, double *b, double s, double *c);
