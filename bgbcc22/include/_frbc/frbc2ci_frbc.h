...
#define FR2C_OP_JCMP_AZI		0x34	//Jump-Compare Arg Zero Int
#define FR2C_OP_JCMP_AZL		0x35	//Jump-Compare Arg Zero Long
#define FR2C_OP_JCMP_AZF		0x36	//Jump-Compare Arg Zero Float
#define FR2C_OP_JCMP_AZD		0x37	//Jump-Compare Arg Zero Double
#define FR2C_OP_JCMP_LZI		0x38	//Jump-Compare Local Zero Int
#define FR2C_OP_JCMP_LZL		0x39	//Jump-Compare Local Zero Long
#define FR2C_OP_JCMP_LZF		0x3A	//Jump-Compare Local Zero Float
#define FR2C_OP_JCMP_LZD		0x3B	//Jump-Compare Local Zero Double
...
//Types 16-255=Builtin Types
#define FR2C_TY_I128			0x10		//Int
#define FR2C_TY_UI128			0x11		//Unsigned Int
...
#define FR2C_TY_TYTYMASK		0xF0000000	//type-type mask
...
// #define FR2C_REGFL_INIT			0x0001000000000000ULL
...
#define FR2C_STATUS_ERR_CALLNOFUNC		-9
