...
#define BGBCC_RIL3OP_OBJBLOB	0x0D

#define BGBCC_RIL3OP_LITSETFID	0x0F
...
#define BGBCC_RIL3OP_STBITMOVE	0x97

#define BGBCC_RIL3OP_LDCONSTBTI	0x98	//load const BitInt 128b
