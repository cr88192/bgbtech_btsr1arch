...
//	opImmRm_imm6u_rn	= 0;
	opImmRm_imm6u_rn	= { opExWI ? UV28_FF : UV28_00,
		istrWord[25], istrWord[ 7: 4]};
...
`endif
	...
	begin
		...
		opImmRm_imm6u	= {opExM ? 5'b11111 : 5'b00000,
			istrJBits[23:0], istrWord[ 3: 0]};

		if(srXG3RV)
		begin
			opImm_disp5u [32:28] = { opExWI, istrJBits[30:28], opExI };
			opImmRm_imm6u[32:28] = { opExWM, istrJBits[30:28], opExM };
		end

		opImm_imm5u		= opImm_disp5u;
		opImm_imm5n		= opImm_disp5u;

//		opImmRm_imm6u	= {opImm_disp5u[32:4], istrWord[ 3: 0]};
		opImmRm_imm6n	= opImmRm_imm6u;
...
`ifdef def_true
			4'h8: begin		/* F2nm_8ejj */
				...
				begin
					...
					/* PMULT indirectly encoded via Immediate */
				end
				else
				begin
					opNmid	= opExQ ?
...
`ifdef def_true
///					if(opIsImm4R)
//					if(opIsImm4R || opIsJumboImm || opExWQ)
...
`endif
		...
		/*
			...
			UW: Rn, ZZR, Disp8s
			UL: Rn, ZZR, Disp10u
			UQ: Rm, RnImm6s, Disp6s		//XG3 + ImmB

			NB: Rm, Rn, disp8s
			NW: ZZR, Rn, Disp8s
			NL: Rn, ZZR, Disp10n
			NQ: RnImm6s, Rm, Disp6s		//XG3 + ImmB
		 */
...
//		default:		begin end
	...
	case(opDoImm)
		JX2_FMIMM_IMM9U, JX2_FMIMM_IMM9N,
		JX2_FMIMM_DISP9U, JX2_FMIMM_IMM9F,
		JX2_FMIMM_IMM10U, JX2_FMIMM_IMM10N:
		begin
			opIsImm9 = 1;
			opIsImmSplit = 0;
		end
