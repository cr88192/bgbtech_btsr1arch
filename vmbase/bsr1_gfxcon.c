...
int BTSR1_GfxCon_UpdateCell(int cx, int cy)
{
...
int BTSR1_MemGfxConCb_GetByte(BTSR1_Context *ctx,
...
int BTSR1_MemGfxConCb_GetWord(BTSR1_Context *ctx,
	BTSR1_MemSpan *sp, btsr1_addr addr)
{
	int ra;
	ra=addr-sp->addr_base;
...
s32 BTSR1_MemGfxConCb_GetDWord(BTSR1_Context *ctx,
	BTSR1_MemSpan *sp, btsr1_addr addr)
{
	s64 rvq;
	int ra, rv;
...
int BTSR1_MemGfxConCb_SetByte(BTSR1_Context *ctx,
...
int BTSR1_MemGfxConCb_SetWord(BTSR1_Context *ctx,
	BTSR1_MemSpan *sp, btsr1_addr addr, int val)
{
	int ra;
	ra=addr-sp->addr_base;
...
int BTSR1_MemGfxConCb_SetDWord(BTSR1_Context *ctx,
...
int BTSR1_MemDefineGfxCon(BTSR1_Context *ctx,
...
//	sp->data=malloc((lim-base)+8);
	...
	sp->GetByte=BTSR1_MemGfxConCb_GetByte;
	sp->GetWord=BTSR1_MemGfxConCb_GetWord;
	sp->GetDWord=BTSR1_MemGfxConCb_GetDWord;
	
	sp->SetByte=BTSR1_MemGfxConCb_SetByte;
	sp->SetWord=BTSR1_MemGfxConCb_SetWord;
	sp->SetDWord=BTSR1_MemGfxConCb_SetDWord;
