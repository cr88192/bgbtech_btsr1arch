...
int BGBCC_BSRC_EmitBinaryVRegVRegInt128(
	BGBCC_TransState *ctx,
	BGBCC_BSR_Context *sctx,
...
//		BGBCC_BSRC_EmitLoadVRegReg(ctx, sctx, dreg, BGBCC_SH_REG_R2);
...
int BGBCC_BSRC_EmitBinaryVRegVRegVRegInt128(
	BGBCC_TransState *ctx,
	BGBCC_BSR_Context *sctx,
	ccxl_type type, ccxl_register dreg,
	int opr,
	ccxl_register sreg, ccxl_register treg)
{
	...
	{
		i=BGBCC_BSRC_EmitBinaryVRegVRegInt128(ctx, sctx, type, dreg, opr, treg);
		return(i);
	}
...
int BGBCC_BSRC_EmitUnaryVRegVRegInt128(
	BGBCC_TransState *ctx,
	BGBCC_BSR_Context *sctx,
	ccxl_type type, ccxl_register dreg,
