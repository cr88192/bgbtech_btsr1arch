...
int BGBCC_BSRC_EmitBinaryVRegVRegVariant(
...
int BGBCC_BSRC_EmitBinaryVRegVRegVRegVariant(
	BGBCC_TransState *ctx,
	BGBCC_BSR_Context *sctx,
	ccxl_type type, ccxl_register dreg,
	int opr,
	ccxl_register sreg, ccxl_register treg)
{
	...
	{
		i=BGBCC_BSRC_EmitBinaryVRegVRegVariant(ctx, sctx, type, dreg, opr, treg);
		return(i);
	}
...
int BGBCC_BSRC_EmitUnaryVRegVRegVariant(
	BGBCC_TransState *ctx,
	BGBCC_BSR_Context *sctx,
	ccxl_type type, ccxl_register dreg,
...
int BGBCC_BSRC_EmitConvToVRegVRegVariant(
	BGBCC_TransState *ctx,
	BGBCC_BSR_Context *sctx,
...
//	rcls=BGBCC_BSRC_TypeGetRegClassP(ctx, type);
	...
	{
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, tri);
		BGBCC_BSRC_EmitLoadVRegReg(ctx, sctx, sreg, tri);
		BGBCC_BSRC_EmitCallName(ctx, sctx, "__lva_conv_toi32");
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, tri);
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, BGBCC_SH_REG_R0);
		BGBCC_BSRC_EmitStoreVRegReg(ctx, sctx, dreg, BGBCC_SH_REG_R0);
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, BGBCC_SH_REG_R0);
		return(1);
	...
	if(BGBCC_CCXL_TypeSgLongP(ctx, type))
	{
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, tri);
		BGBCC_BSRC_EmitLoadVRegReg(ctx, sctx, sreg, tri);
		BGBCC_BSRC_EmitCallName(ctx, sctx, "__lva_conv_toi64");
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, tri);
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, tro);
		BGBCC_BSRC_EmitStoreVRegReg(ctx, sctx, dreg, tro);
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, tro);
		return(1);
	}
		...
		BGBCC_CCXL_TypeFloat16P(ctx, type))
	{
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, tri);
		BGBCC_BSRC_EmitLoadVRegReg(ctx, sctx, sreg, tri);
		BGBCC_BSRC_EmitCallName(ctx, sctx, "__lva_conv_tof32");
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, tri);
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, fr0);
		BGBCC_BSRC_EmitStoreVRegReg(ctx, sctx, dreg, fr0);
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, fr0);
		return(1);
	}
	...
	if(BGBCC_CCXL_TypeDoubleP(ctx, type))
	{
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, tri);
		BGBCC_BSRC_EmitLoadVRegReg(ctx, sctx, sreg, tri);
		BGBCC_BSRC_EmitCallName(ctx, sctx, "__lva_conv_tof64");
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, tri);
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, dr0);
		BGBCC_BSRC_EmitStoreVRegReg(ctx, sctx, dreg, dr0);
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, dr0);
		return(1);
	}
	...
	if(BGBCC_CCXL_TypePointerP(ctx, type))
	{
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, tri);
		BGBCC_BSRC_EmitLoadVRegReg(ctx, sctx, sreg, tri);
		BGBCC_BSRC_EmitCallName(ctx, sctx, "__lva_conv_toptr");
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, tri);
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, BGBCC_SH_REG_R0);
		BGBCC_BSRC_EmitStoreVRegReg(ctx, sctx, dreg, BGBCC_SH_REG_R0);
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, BGBCC_SH_REG_R0);
	...
	if(0)
	{
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, BGBCC_SH_REG_LR4);
		BGBCC_BSRC_EmitLoadVRegReg(ctx, sctx, dreg, BGBCC_SH_REG_LR4);
		BGBCC_BSRC_EmitCallName(ctx, sctx, opn);
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, BGBCC_SH_REG_LR4);
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, BGBCC_SH_REG_LR0);
		BGBCC_BSRC_EmitStoreVRegReg(ctx, sctx, dreg, BGBCC_SH_REG_LR0);
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, BGBCC_SH_REG_LR0);
...
int BGBCC_BSRC_EmitConvFromVRegVRegVariant(
	BGBCC_TransState *ctx,
	BGBCC_BSR_Context *sctx,
	ccxl_type type, ccxl_register dreg, ccxl_register sreg)
{
	...
	if(BGBCC_CCXL_TypeSmallIntP(ctx, type))
	{
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, BGBCC_SH_REG_R4);
		BGBCC_BSRC_EmitLoadVRegReg(ctx, sctx, sreg, BGBCC_SH_REG_R4);
		BGBCC_BSRC_EmitCallName(ctx, sctx, "__lva_conv_fromi32");
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, BGBCC_SH_REG_R4);
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, tro);
		BGBCC_BSRC_EmitStoreVRegReg(ctx, sctx, dreg, tro);
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, tro);
	...
	if(BGBCC_CCXL_TypeSgLongP(ctx, type))
	{
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, tri);
		BGBCC_BSRC_EmitLoadVRegReg(ctx, sctx, sreg, tri);
		BGBCC_BSRC_EmitCallName(ctx, sctx, "__lva_conv_fromi64");
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, tri);
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, tro);
		BGBCC_BSRC_EmitStoreVRegReg(ctx, sctx, dreg, tro);
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, tro);
	...
	if(BGBCC_CCXL_TypeFloatP(ctx, type))
	{
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, fr4);
		BGBCC_BSRC_EmitLoadVRegReg(ctx, sctx, sreg, fr4);
		BGBCC_BSRC_EmitCallName(ctx, sctx, "__lva_conv_fromf32");
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, fr4);
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, tro);
		BGBCC_BSRC_EmitStoreVRegReg(ctx, sctx, dreg, tro);
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, tro);
		return(1);
	...
	if(BGBCC_CCXL_TypeDoubleP(ctx, type))
	{
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, dr4);
		BGBCC_BSRC_EmitLoadVRegReg(ctx, sctx, sreg, dr4);
		BGBCC_BSRC_EmitCallName(ctx, sctx, "__lva_conv_fromf64");
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, dr4);
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, tro);
		BGBCC_BSRC_EmitStoreVRegReg(ctx, sctx, dreg, tro);
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, tro);
		return(1);
	...
	if(BGBCC_CCXL_TypePointerP(ctx, type))
	{
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, BGBCC_SH_REG_R4);
		BGBCC_BSRC_EmitLoadVRegReg(ctx, sctx, sreg, BGBCC_SH_REG_R4);
		BGBCC_BSRC_EmitCallName(ctx, sctx, "__lva_conv_fromptr");
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, BGBCC_SH_REG_R4);
		BGBCC_BSRC_ScratchSafeStompReg(ctx, sctx, tro);
		BGBCC_BSRC_EmitStoreVRegReg(ctx, sctx, dreg, tro);
		BGBCC_BSRC_ScratchReleaseReg(ctx, sctx, tro);
