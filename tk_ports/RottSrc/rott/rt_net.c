	...
	if (demoplayback==true)
	{
		...
		if(demoposlog)
		{
			fprintf(demoposlog, "XY %d %d %d  %d %d  %d %d %d\n",
				...
				locplayerstate->dmomx,
				locplayerstate->dmomy);
		}
#endif
		...
		if(demoposlog)
		{
			...
			sscanf(tbuf, "XY %d %d %d  %d %d  %d %d %d\n",
...
//				__debugbreak();
			...
			{
//				printf("Demo-Mismatch dmox=%d dmoy=%d\n",
//					dmx-locplayerstate->dmomx,
//					dmy-locplayerstate->dmomy);
