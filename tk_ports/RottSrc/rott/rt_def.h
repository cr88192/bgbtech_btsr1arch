...
#define		stricmp		rt_stricmp
#define		strcmpi		stricmp

#ifdef	__GNUC__
#define		__debugbreak	rt_dbgbreak
#endif

char *rt_itoa(int val, char *buf, int radix);
char *rt_ltoa(long val, char *buf, int radix);
char *rt_ultoa(unsigned long val, char *buf, int radix);

int rt_stricmp(const char *stra, const char *strb);
void rt_dbgbreak();
...
#define FINEANGLEMSK						(FINEANGLES-1)
