...
//		VectorSubtract(aasworld.vertexes[edge->v[!side]], v, d2);
		...
		VectorSubtract(
			(float *)(aasworld.vertexes)+((edge->v[side])*3), v, d1);
		VectorSubtract(
			(float *)(aasworld.vertexes)+((edge->v[!side])*3), v, d2);
...
//	VectorCopy(aasworld.vertexes[edge->v[0]], corner);
	VectorCopy((float *)(aasworld.vertexes)+((edge->v[0])*3), corner);
...
//		VectorAdd(center, aasworld.vertexes[edge->v[1]], center);
		VectorAdd(center,
			(float *)(aasworld.vertexes)+((edge->v[0])*3), center);
		VectorAdd(center,
			(float *)(aasworld.vertexes)+((edge->v[1])*3), center);
	} //end for
...
//								aasworld.vertexes[edge->v[0]], dir);
					...
					VectorSubtract(
						(float *)(aasworld.vertexes)+(edge->v[1])*3,
						(float *)(aasworld.vertexes)+(edge->v[0])*3, dir);
...
//								aasworld.vertexes[edge->v[1]], start);
					...
					VectorAdd(
						(float *)(aasworld.vertexes)+(edge->v[0])*3,
						(float *)(aasworld.vertexes)+(edge->v[1])*3, start);
...
//								aasworld.vertexes[edge->v[!side]], edgevec);
					...
					VectorSubtract(
						(float *)(aasworld.vertexes)+(edge->v[side])*3,
						(float *)(aasworld.vertexes)+(edge->v[!side])*3, 
						edgevec);
...
//			VectorCopy(aasworld.vertexes[edge1->v[side1]], v2);
			VectorCopy((float *)(aasworld.vertexes)+(edge1->v[!side1])*3, v1);
			VectorCopy((float *)(aasworld.vertexes)+(edge1->v[side1])*3, v2);
...
//					VectorCopy(aasworld.vertexes[edge2->v[1]], v4);
					VectorCopy(
						(float *)(aasworld.vertexes)+(edge2->v[0])*3, v3);
					VectorCopy(
						(float *)(aasworld.vertexes)+(edge2->v[1])*3, v4);
...
//		VectorCopy(aasworld.vertexes[sharededge->v[!firstv]], v2);
		...
		VectorCopy(
			(float *)(aasworld.vertexes)+(sharededge->v[firstv])*3, v1);
		VectorCopy(
			(float *)(aasworld.vertexes)+(sharededge->v[!firstv])*3, v2);
...
//				VectorCopy(aasworld.vertexes[edge1->v[1]], v2);
				...
				VectorCopy((float *)(aasworld.vertexes)+(edge1->v[0])*3, v1);
				VectorCopy((float *)(aasworld.vertexes)+(edge1->v[1])*3, v2);
