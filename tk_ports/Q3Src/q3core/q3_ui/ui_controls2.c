...
#if 1
static menucommon_s *g_movement_controls[12];
static menucommon_s *g_weapons_controls[14];
static menucommon_s *g_looking_controls[12];
static menucommon_s *g_misc_controls[8];
static menucommon_s **g_controls[5];

#if 1
void Controls_InitArrays()
{
	g_movement_controls[ 0] = (menucommon_s *)&s_controls.alwaysrun;
	g_movement_controls[ 1] = (menucommon_s *)&s_controls.run;
	g_movement_controls[ 2] = (menucommon_s *)&s_controls.walkforward;
	g_movement_controls[ 3] = (menucommon_s *)&s_controls.backpedal;
	g_movement_controls[ 4] = (menucommon_s *)&s_controls.stepleft;
	g_movement_controls[ 5] = (menucommon_s *)&s_controls.stepright;
	g_movement_controls[ 6] = (menucommon_s *)&s_controls.moveup;
	g_movement_controls[ 7] = (menucommon_s *)&s_controls.movedown;
	g_movement_controls[ 8] = (menucommon_s *)&s_controls.turnleft;
	g_movement_controls[ 9] = (menucommon_s *)&s_controls.turnright;
	g_movement_controls[10] = (menucommon_s *)&s_controls.sidestep;

	g_weapons_controls[ 0] = (menucommon_s *)&s_controls.attack;
	g_weapons_controls[ 1] = (menucommon_s *)&s_controls.nextweapon;
	g_weapons_controls[ 2] = (menucommon_s *)&s_controls.prevweapon;
	g_weapons_controls[ 3] = (menucommon_s *)&s_controls.autoswitch;
	g_weapons_controls[ 4] = (menucommon_s *)&s_controls.chainsaw;
	g_weapons_controls[ 5] = (menucommon_s *)&s_controls.machinegun;
	g_weapons_controls[ 6] = (menucommon_s *)&s_controls.shotgun;
	g_weapons_controls[ 7] = (menucommon_s *)&s_controls.grenadelauncher;
	g_weapons_controls[ 8] = (menucommon_s *)&s_controls.rocketlauncher;
	g_weapons_controls[ 9] = (menucommon_s *)&s_controls.lightning;
	g_weapons_controls[10] = (menucommon_s *)&s_controls.railgun;
	g_weapons_controls[11] = (menucommon_s *)&s_controls.plasma;
	g_weapons_controls[12] = (menucommon_s *)&s_controls.bfg;

	g_looking_controls[ 0] = (menucommon_s *)&s_controls.sensitivity;
	g_looking_controls[ 1] = (menucommon_s *)&s_controls.smoothmouse;
	g_looking_controls[ 2] = (menucommon_s *)&s_controls.invertmouse;
	g_looking_controls[ 3] = (menucommon_s *)&s_controls.lookup;
	g_looking_controls[ 4] = (menucommon_s *)&s_controls.lookdown;
	g_looking_controls[ 5] = (menucommon_s *)&s_controls.mouselook;
	g_looking_controls[ 6] = (menucommon_s *)&s_controls.freelook;
	g_looking_controls[ 7] = (menucommon_s *)&s_controls.centerview;
	g_looking_controls[ 8] = (menucommon_s *)&s_controls.zoomview;
	g_looking_controls[ 9] = (menucommon_s *)&s_controls.joyenable;
	g_looking_controls[10] = (menucommon_s *)&s_controls.joythreshold;

	g_misc_controls[0] = (menucommon_s *)&s_controls.showscores;
	g_misc_controls[1] = (menucommon_s *)&s_controls.useitem;
	g_misc_controls[2] = (menucommon_s *)&s_controls.gesture;
	g_misc_controls[3] = (menucommon_s *)&s_controls.chat;
	g_misc_controls[4] = (menucommon_s *)&s_controls.chat2;
	g_misc_controls[5] = (menucommon_s *)&s_controls.chat3;
	g_misc_controls[6] = (menucommon_s *)&s_controls.chat4;

	g_controls[0] = g_movement_controls;
	g_controls[1] = g_looking_controls;
	g_controls[2] = g_weapons_controls;
	g_controls[3] = g_misc_controls;
}
#endif
