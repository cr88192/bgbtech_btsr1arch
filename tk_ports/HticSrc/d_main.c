...
boolean ExtendedWAD;	// true if episodes 4 and 5 present
...
void D_DoomMain(void)
{
	...
	if(w_chkaccess("hticulz.wad")>=0)
	{
		wadfiles[0] = "hticulz.wad";
	}else if(w_chkaccess("htic1lz.wad")>=0)
	{
		wadfiles[0] = "htic1lz.wad";
	}else if(w_chkaccess("heretic.wad")>=0)
	{
		wadfiles[0] = "heretic.wad";
	}else if(w_chkaccess("heretic1.wad")>=0)
	{
		wadfiles[0] = "heretic1.wad";
	}else
	{
		I_Error("No wadfile found\n");
	}
