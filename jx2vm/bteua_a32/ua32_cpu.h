...
#if defined(UA32_WINARM) || defined(UA32_WINARM64)
#ifndef UA32_WINDOWS
#define UA32_WINDOWS
#endif
#endif
...
#define UA32_NMID_BLX		0x2E
#define UA32_NMID_NEG		0x2F
#define UA32_NMID_LSL		0x30
#define UA32_NMID_LSR		0x31
#define UA32_NMID_ASR		0x32
#define UA32_NMID_ROR		0x33
#define UA32_NMID_BKPT		0x34
#define UA32_NMID_ADR		0x35
#define UA32_NMID_ADRW		0x36

#define UA32_NMID_VMOV_CRR	0x38
#define UA32_NMID_VMOV_RRC	0x39

// #define UA32_NMID_BX		0x07

#define UA32_NMID_ADCS		0x81
#define UA32_NMID_ADDS		0x82
#define UA32_NMID_BS		0x84
#define UA32_NMID_ANDS		0x83
#define UA32_NMID_BICS		0x85
#define UA32_NMID_BLS		0x86
#define UA32_NMID_BXS		0x87
...
#define UA32_RLC_REL24T		0x0C		//Thumb2 (Long Branch)
#define UA32_RLC_REL16TB	0x0D		//Thumb2 ADRW
...
int reg_live;	//register is currently in use
int reg_resv;	
int reg_valid;	//register is valid
int reg_dirty;	//register is dirty
