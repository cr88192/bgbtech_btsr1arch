...
{
	static const short key2scan[256]={
		...
		0x009, 0x078, 0x007, 0x170, 0x17A, 0x17D, 0x16C, 0x169,		//90..97
		0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000,		//98..9F
